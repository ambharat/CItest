...
public class TRESTBeginJava
{
  ...
  protected final String TEXT_128 = ".Body = errorResponse_";
  protected final String TEXT_129 = ".getEntity(String.class);" + NL + "\t\t\t\t\t";
  protected final String TEXT_130 = ".ERROR_CODE = errorResponse_";
  protected final String TEXT_131 = ".getStatus();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_132 = ".Body = restResponse_";
