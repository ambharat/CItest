...
public class ComponentBegin
{
  ...
  protected final String TEXT_129 = " = String.valueOf(";
  protected final String TEXT_130 = ".get(";
  protected final String TEXT_131 = ")).charAt(0);";
  protected final String TEXT_132 = NL + "                    \t";
  protected final String TEXT_133 = ".";
  protected final String TEXT_134 = " = ParserUtils.parseTo_Document(String.valueOf(";
  ...
  protected final String TEXT_144 = NL + NL + "org.talend.components.api.component.ComponentDefinition def_";
  protected final String TEXT_145 = " =" + NL + "        new ";
  protected final String TEXT_146 = "();";
  protected final String TEXT_147 = NL;
  protected final String TEXT_148 = NL;
  protected final String TEXT_149 = " props_";
  protected final String TEXT_150 = " =" + NL + "        (";
  protected final String TEXT_151 = ") def_";
  protected final String TEXT_152 = ".createRuntimeProperties();";
  protected final String TEXT_153 = NL + "                    java.util.List<Object> ";
  protected final String TEXT_154 = " = new java.util.ArrayList<Object>();";
  ...
  protected final String TEXT_163 = NL + "                    ((org.talend.daikon.properties.Properties)props_";
  ...
  protected final String TEXT_169 = "\"," + NL + "                        routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_170 = "));";
  protected final String TEXT_171 = NL + "                    props_";
  protected final String TEXT_172 = ".setValue(\"";
  protected final String TEXT_173 = "\"," + NL + "                        TalendDate.parseDate(\"yyyy-MM-dd HH:mm:ss\",";
  ...
  protected final String TEXT_183 = "\"," + NL + "                        new org.apache.avro.Schema.Parser().parse(";
  protected final String TEXT_184 = "));";
  protected final String TEXT_185 = NL + "                    props_";
  protected final String TEXT_186 = ".setValue(\"";
  protected final String TEXT_187 = "\",";
  protected final String TEXT_188 = NL + "                    ";
  protected final String TEXT_189 = ");";
  protected final String TEXT_190 = NL + "org.talend.components.api.container.RuntimeContainer container_";
  ...
  protected final String TEXT_192 = "\";" + NL + "    }" + NL + "    " + NL + "    public Object getGlobalData(String key) {" + NL + "    \treturn globalMap.get(key);" + NL + "    }" + NL + "};" + NL + "" + NL + "int nb_line_";
  protected final String TEXT_193 = " = 0;" + NL + "" + NL + "org.talend.components.api.component.ConnectorTopology topology_";
  protected final String TEXT_194 = " = null;";
  protected final String TEXT_195 = NL + "topology_";
  protected final String TEXT_196 = " = org.talend.components.api.component.ConnectorTopology.INCOMING_AND_OUTGOING;";
  protected final String TEXT_197 = NL + "topology_";
  protected final String TEXT_198 = " = org.talend.components.api.component.ConnectorTopology.INCOMING;";
  protected final String TEXT_199 = NL + "topology_";
  protected final String TEXT_200 = " = org.talend.components.api.component.ConnectorTopology.OUTGOING;";
  protected final String TEXT_201 = NL + "topology_";
  protected final String TEXT_202 = " = org.talend.components.api.component.ConnectorTopology.NONE;";
  protected final String TEXT_203 = NL + NL + "org.talend.daikon.runtime.RuntimeInfo runtime_info_";
  protected final String TEXT_204 = " = def_";
  protected final String TEXT_205 = ".getRuntimeInfo(props_";
  protected final String TEXT_206 = ", topology_";
  protected final String TEXT_207 = ");" + NL + "java.util.Set<org.talend.components.api.component.ConnectorTopology> supported_connector_topologies_";
  protected final String TEXT_208 = " = def_";
  protected final String TEXT_209 = ".getSupportedConnectorTopologies();" + NL + "" + NL + "org.talend.components.api.component.runtime.SourceOrSink sourceOrSink_";
  protected final String TEXT_210 = " = (org.talend.components.api.component.runtime.SourceOrSink)(Class.forName(runtime_info_";
  protected final String TEXT_211 = ".getRuntimeClassName()).newInstance());" + NL + "sourceOrSink_";
  protected final String TEXT_212 = ".initialize(container_";
  ...
  protected final String TEXT_219 = ".getMessage());" + NL + "}" + NL + "    ";
  ...
  protected final String TEXT_226 = NL + "        boolean multi_output_is_allowed_";
  protected final String TEXT_227 = " = false;";
  protected final String TEXT_228 = NL + "        org.talend.components.api.component.Connector c_";
  protected final String TEXT_229 = " = null;" + NL + "        for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_230 = ".getAvailableConnectors(null, true)) {" + NL + "            if (currentConnector.getName().equals(\"";
  protected final String TEXT_231 = "\")) {" + NL + "                c_";
  protected final String TEXT_232 = " = currentConnector;" + NL + "            }" + NL + "    " + NL + "            if (currentConnector.getName().equals(\"REJECT\")) {//it's better to move the code to javajet" + NL + "                multi_output_is_allowed_";
  protected final String TEXT_233 = " = true;" + NL + "            }" + NL + "        }" + NL + "        org.apache.avro.Schema schema_";
  protected final String TEXT_234 = " = props_";
  protected final String TEXT_235 = ".getSchema(c_";
  protected final String TEXT_236 = ", true);" + NL;
  protected final String TEXT_237 = NL + "\t" + NL + "    // Iterate through the incoming data." + NL + "    boolean available_";
  protected final String TEXT_238 = " = reader_";
  protected final String TEXT_239 = ".start();" + NL + "    " + NL + "    resourceMap.put(\"reader_";
  protected final String TEXT_240 = "\", reader_";
  protected final String TEXT_241 = ");" + NL + "    " + NL + "    for (; available_";
  protected final String TEXT_242 = "; available_";
  protected final String TEXT_243 = " = reader_";
  protected final String TEXT_244 = ".advance()) {" + NL + "    \tnb_line_";
  protected final String TEXT_245 = "++;" + NL + "    \t" + NL + "    \t";
  protected final String TEXT_246 = NL + "        if (multi_output_is_allowed_";
  ...
  protected final String TEXT_254 = NL + NL + "        try {" + NL + "            Object data_";
  protected final String TEXT_255 = " = reader_";
  protected final String TEXT_256 = ".getCurrent();";
  protected final String TEXT_257 = NL + NL + "                if(multi_output_is_allowed_";
  protected final String TEXT_258 = ") {";
  protected final String TEXT_259 = NL + "                    ";
  protected final String TEXT_260 = " = new ";
  protected final String TEXT_261 = "Struct();" + NL + "                }" + NL;
  protected final String TEXT_262 = NL + "        } catch (org.talend.components.api.exception.DataRejectException e_";
  protected final String TEXT_263 = ") {" + NL + "        \tjava.util.Map<String,Object> info_";
  protected final String TEXT_264 = " = e_";
  protected final String TEXT_265 = ".getRejectInfo();";
  protected final String TEXT_266 = NL + "                Object data_";
  protected final String TEXT_267 = " = info_";
  protected final String TEXT_268 = ".get(\"talend_record\");" + NL + "" + NL + "                if (multi_output_is_allowed_";
  protected final String TEXT_269 = ") {";
  protected final String TEXT_270 = NL + "                    ";
  protected final String TEXT_271 = " = new ";
  protected final String TEXT_272 = "Struct();" + NL + "                }" + NL + "\t\t\t\ttry{";
  protected final String TEXT_273 = NL + "                }catch(java.lang.Exception e){" + NL + "                \t// do nothing" + NL + "                }";
  protected final String TEXT_274 = NL + "                        ";
  protected final String TEXT_275 = ".";
  protected final String TEXT_276 = " = (";
  protected final String TEXT_277 = ")info_";
  protected final String TEXT_278 = ".get(\"";
  protected final String TEXT_279 = "\");";
  protected final String TEXT_280 = NL + "                    ";
  protected final String TEXT_281 = " = null;";
  protected final String TEXT_282 = NL + "            \t//TODO use a method instead of getting method by the special key \"error\"" + NL + "            \tString errorMessage_";
  protected final String TEXT_283 = " = \"Row \"+ nb_line_";
  protected final String TEXT_284 = " + \":\" + info_";
  protected final String TEXT_285 = ".get(\"error\");" + NL + "    \t\t\tSystem.err.println(errorMessage_";
  protected final String TEXT_286 = ");";
  protected final String TEXT_287 = NL + "    }";
  protected final String TEXT_288 = NL + "    org.talend.components.api.component.runtime.Sink sink_";
  protected final String TEXT_289 = " =" + NL + "            (org.talend.components.api.component.runtime.Sink)sourceOrSink_";
  protected final String TEXT_290 = ";" + NL + "    org.talend.components.api.component.runtime.WriteOperation writeOperation_";
  protected final String TEXT_291 = " = sink_";
  protected final String TEXT_292 = ".createWriteOperation();" + NL + "    writeOperation_";
  protected final String TEXT_293 = ".initialize(container_";
  protected final String TEXT_294 = ");" + NL + "    org.talend.components.api.component.runtime.Writer writer_";
  protected final String TEXT_295 = " = writeOperation_";
  protected final String TEXT_296 = ".createWriter(container_";
  protected final String TEXT_297 = ");" + NL + "    writer_";
  protected final String TEXT_298 = ".open(\"";
  protected final String TEXT_299 = "\");" + NL + "    " + NL + "    resourceMap.put(\"writer_";
  protected final String TEXT_300 = "\", writer_";
  protected final String TEXT_301 = ");" + NL + "    " + NL + "    org.talend.components.api.component.Connector c_";
  protected final String TEXT_302 = " = null;" + NL + "    for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_303 = ".getAvailableConnectors(null, false)) {" + NL + "        if (currentConnector.getName().equals(\"MAIN\")) {" + NL + "            c_";
  protected final String TEXT_304 = " = currentConnector;" + NL + "            break;" + NL + "        }" + NL + "    }" + NL + "    org.apache.avro.Schema designSchema_";
  protected final String TEXT_305 = " = props_";
  protected final String TEXT_306 = ".getSchema(c_";
  protected final String TEXT_307 = ", false);" + NL + "    org.talend.daikon.di.DiIncomingSchemaEnforcer current_";
  protected final String TEXT_308 = NL + "            = new org.talend.daikon.di.DiIncomingSchemaEnforcer(designSchema_";
  protected final String TEXT_309 = ");";
  protected final String TEXT_310 = NL + "                c_";
  protected final String TEXT_311 = " = null;" + NL + "                for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_312 = ".getAvailableConnectors(null, true)) {" + NL + "                    if (currentConnector.getName().equals(\"MAIN\")) {" + NL + "                        c_";
  protected final String TEXT_313 = " = currentConnector;" + NL + "                    }" + NL + "                }" + NL + "                org.apache.avro.Schema mainSchema_";
  protected final String TEXT_314 = " = props_";
  protected final String TEXT_315 = ".getSchema(c_";
  protected final String TEXT_316 = ", true);";
  protected final String TEXT_317 = NL + "                c_";
  protected final String TEXT_318 = " = null;" + NL + "                for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_319 = ".getAvailableConnectors(null, true)) {" + NL + "                    if (currentConnector.getName().equals(\"REJECT\")) {" + NL + "                        c_";
  protected final String TEXT_320 = " = currentConnector;" + NL + "                    }" + NL + "                }" + NL + "                org.apache.avro.Schema rejectSchema_";
  protected final String TEXT_321 = " = props_";
  protected final String TEXT_322 = ".getSchema(c_";
