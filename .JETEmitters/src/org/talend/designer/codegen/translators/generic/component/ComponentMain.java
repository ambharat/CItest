...
public class ComponentMain
{
  ...
  protected final String TEXT_146 = NL + "                if (current_";
  protected final String TEXT_147 = ".needsInitDynamicColumns()) {" + NL + "                    // Initialize the dynamic columns when they are first encountered." + NL + "                    for (routines.system.DynamicMetadata dm_";
  protected final String TEXT_148 = " : ";
  protected final String TEXT_149 = ".";
  protected final String TEXT_150 = ".metadatas) {" + NL + "                        current_";
  protected final String TEXT_151 = ".initDynamicColumn(" + NL + "                                dm_";
  protected final String TEXT_152 = ".getName(), dm_";
  protected final String TEXT_153 = ".getDbName()," + NL + "                                dm_";
  protected final String TEXT_154 = ".getType(), dm_";
  protected final String TEXT_155 = ".getDbType()," + NL + "                                dm_";
  protected final String TEXT_156 = ".getDbTypeId(), dm_";
  protected final String TEXT_157 = ".getLength()," + NL + "                                dm_";
  protected final String TEXT_158 = ".getPrecision(), dm_";
  protected final String TEXT_159 = ".getFormat()," + NL + "                                dm_";
  protected final String TEXT_160 = ".getDescription(), dm_";
  protected final String TEXT_161 = ".isKey()," + NL + "                                dm_";
  protected final String TEXT_162 = ".isNullable()," + NL + "                                dm_";
  protected final String TEXT_163 = ".getRefFieldName(), dm_";
  protected final String TEXT_164 = ".getRefModuleName());" + NL + "                    }" + NL + "                    current_";
  protected final String TEXT_165 = ".initDynamicColumnsFinished();" + NL + "                }";
  protected final String TEXT_166 = NL + "                    current_";
  protected final String TEXT_167 = ".put(\"";
  protected final String TEXT_168 = "\", ";
  protected final String TEXT_169 = ".";
  protected final String TEXT_170 = ");";
  protected final String TEXT_171 = NL + "                    for (int i = 0; i < ";
  protected final String TEXT_172 = ".";
  protected final String TEXT_173 = ".getColumnCount(); i++) {" + NL + "                        current_";
  protected final String TEXT_174 = ".put(";
  protected final String TEXT_175 = ".";
  protected final String TEXT_176 = ".getColumnMetadata(i).getName(),";
  protected final String TEXT_177 = NL + "                                ";
  protected final String TEXT_178 = ".";
  protected final String TEXT_179 = ".getColumnValue(i));" + NL + "                    }";
  protected final String TEXT_180 = NL + "            Object data_";
  protected final String TEXT_181 = " = current_";
  protected final String TEXT_182 = ".createIndexedRecord();" + NL + "" + NL + "            writer_";
  protected final String TEXT_183 = ".write(data_";
  protected final String TEXT_184 = ");" + NL + "            " + NL + "            nb_line_";
  protected final String TEXT_185 = "++;";
  protected final String TEXT_186 = NL + "            \tif(writer_";
  protected final String TEXT_187 = " instanceof org.talend.components.api.component.runtime.WriterWithFeedback<?, ?, ?>){" + NL + "                    java.util.Iterator<?> outgoingMainRecords_";
  protected final String TEXT_188 = " = ((org.talend.components.api.component.runtime.WriterWithFeedback<?, ?, ?>)writer_";
  protected final String TEXT_189 = ").getSuccessfulWrites().iterator();" + NL + "                    Object outgoingMain_";
  protected final String TEXT_190 = " = null;" + NL + "                    if (outgoingMainRecords_";
  protected final String TEXT_191 = ".hasNext()) {" + NL + "                        outgoingMain_";
  protected final String TEXT_192 = " = outgoingMainRecords_";
  protected final String TEXT_193 = ".next();" + NL + "                        if(outgoingMainRecords_";
  protected final String TEXT_194 = ".hasNext()){" + NL + "                        \toutgoingMain_";
  protected final String TEXT_195 = " = data_";
  protected final String TEXT_196 = ";" + NL + "                        }" + NL + "                    }";
  protected final String TEXT_197 = NL + "                    else{" + NL + "                    \tif (!((org.talend.components.api.component.runtime.WriterWithFeedback<?, ?, ?>)writer_";
  protected final String TEXT_198 = ").getRejectedWrites().iterator().hasNext()) {" + NL + "                    \t\toutgoingMain_";
  protected final String TEXT_199 = " = data_";
  protected final String TEXT_200 = ";" + NL + "                    \t}" + NL + "                    }";
  protected final String TEXT_201 = NL + "                    if(outgoingMain_";
  protected final String TEXT_202 = "!=null){" + NL + "                    \t";
  protected final String TEXT_203 = " = new ";
  protected final String TEXT_204 = "Struct();" + NL + "                    \t";
  protected final String TEXT_205 = NL + "                    }" + NL + "              \t}else{" + NL + "              \t\t// For no feedback writer,just pass the input record to the output" + NL + "              \t\tif(data_";
  protected final String TEXT_206 = "!=null){" + NL + "                  \t\t";
  protected final String TEXT_207 = " = new ";
  protected final String TEXT_208 = "Struct();" + NL + "                \t\t";
  protected final String TEXT_209 = NL + "                  \t}" + NL + "            \t}";
  protected final String TEXT_210 = NL + "                    java.util.Iterator<?> outgoingRejectRecords_";
  protected final String TEXT_211 = " = ((org.talend.components.api.component.runtime.WriterWithFeedback<?, ?, ?>)writer_";
  protected final String TEXT_212 = ").getRejectedWrites().iterator();" + NL + "                    if (outgoingRejectRecords_";
  protected final String TEXT_213 = ".hasNext()) {";
  protected final String TEXT_214 = NL + "                        ";
  protected final String TEXT_215 = " = new ";
  protected final String TEXT_216 = "Struct();" + NL + "                        Object outgoingReject_";
  protected final String TEXT_217 = " = outgoingRejectRecords_";
