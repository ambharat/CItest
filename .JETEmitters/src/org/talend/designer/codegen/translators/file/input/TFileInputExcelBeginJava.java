...
public class TFileInputExcelBeginJava
{
  ...
  protected final String TEXT_387 = NL + "        if(emptyColumnCount_";
  protected final String TEXT_388 = " >= ";
  protected final String TEXT_389 = "+dynamic_column_count_";
  protected final String TEXT_390 = "-1";
  protected final String TEXT_391 = "){" + NL + "        \tbreak; //if meet the empty row, there will break the iterate." + NL + "        }";
  protected final String TEXT_392 = NL + "\t\t\tnb_line_";
  protected final String TEXT_393 = "++;" + NL + "\t\t\t";
  protected final String TEXT_394 = NL + "    } catch (java.lang.Exception e) {" + NL + "        whetherReject_";
  ...
  protected final String TEXT_809 = NL + "        if(emptyColumnCount_";
  protected final String TEXT_810 = " >= ";
  protected final String TEXT_811 = "+dynamic_column_count_";
  protected final String TEXT_812 = "-1";
  protected final String TEXT_813 = "){" + NL + "        \tbreak; //if meet the empty row, there will break the iterate." + NL + "        }";
  protected final String TEXT_814 = NL + "\t\t\t\tnb_line_";
  ...
  protected final String TEXT_1083 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1084 = "+ \" column: \" + curColName_";
  protected final String TEXT_1085 = " + \" (No. \" + curColNum_";
  ...
  protected final String TEXT_1091 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1092 = "+ \" column: \" + curColName_";
  protected final String TEXT_1093 = " + \" (No. \" + curColNum_";
  protected final String TEXT_1094 = " + \")\";";
  protected final String TEXT_1095 = NL + "\t\t\t}" + NL;
  protected final String TEXT_1096 = NL + "        \t\t";
  protected final String TEXT_1097 = "if(!whetherReject_";
  protected final String TEXT_1098 = ") { ";
  protected final String TEXT_1099 = NL + "                     if(";
  protected final String TEXT_1100 = " == null){" + NL + "                    \t ";
  protected final String TEXT_1101 = " = new ";
  protected final String TEXT_1102 = "Struct();" + NL + "                     }";
