...
public class TJavaDBInputBeginJava
{
  ...
  protected final String TEXT_405 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_406 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_407 = ".getColumnTypeName(i_";
  protected final String TEXT_408 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_409 = ".add(rs_";
  protected final String TEXT_410 = ".getString(i_";
  protected final String TEXT_411 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_412 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_413 = ".";
  protected final String TEXT_414 = ", rs_";
  protected final String TEXT_415 = ", fixedColumnCount_";
  protected final String TEXT_416 = ",list_";
  protected final String TEXT_417 = ",";
  protected final String TEXT_418 = ");";
  protected final String TEXT_419 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  ...
  protected final String TEXT_431 = NL + "                                  Object geom = rs_";
  protected final String TEXT_432 = ".getObject(";
  protected final String TEXT_433 = "column_index_";
  protected final String TEXT_434 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_435 = ".";
  protected final String TEXT_436 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
