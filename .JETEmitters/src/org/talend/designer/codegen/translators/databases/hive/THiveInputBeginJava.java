...
public class THiveInputBeginJava
{
  ...
  protected final String TEXT_507 = NL + "                        \tmaprLogin_";
  protected final String TEXT_508 = ".getMapRCredentialsViaPassword(";
  protected final String TEXT_509 = ", ";
  protected final String TEXT_510 = ", decryptedMaprPassword_";
  protected final String TEXT_511 = ", ";
  protected final String TEXT_512 = ");" + NL + "                        \t";
  protected final String TEXT_513 = NL + "\t\t\t\t\t\t\tString decryptedSslStorePassword_";
  protected final String TEXT_514 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_515 = ");";
  protected final String TEXT_516 = NL + "\t\t\t\t\t\t\tString decryptedSslStorePassword_";
  protected final String TEXT_517 = " = ";
  protected final String TEXT_518 = ";";
  protected final String TEXT_519 = NL + "\t\t\t\t\t\tString url_";
  protected final String TEXT_520 = " = \"jdbc:";
  protected final String TEXT_521 = "://\" + ";
  protected final String TEXT_522 = " + \":\" + ";
  protected final String TEXT_523 = " + \"/\" + ";
  protected final String TEXT_524 = "+ \";ssl=true\" +\";sslTrustStore=\" + ";
  protected final String TEXT_525 = " + \";trustStorePassword=\" + decryptedSslStorePassword_";
  protected final String TEXT_526 = ";";
  protected final String TEXT_527 = NL + "\t\t\t\t\t\tString url_";
  protected final String TEXT_528 = " = \"jdbc:";
  protected final String TEXT_529 = "://\" + ";
  protected final String TEXT_530 = " + \":\" + ";
  protected final String TEXT_531 = " + \"/\" + ";
  protected final String TEXT_532 = ";";
  protected final String TEXT_533 = NL + "\t\t\t\tString additionalJdbcSettings_";
  protected final String TEXT_534 = " = ";
  protected final String TEXT_535 = ";" + NL + "\t\t\t\tif(!\"\".equals(additionalJdbcSettings_";
  protected final String TEXT_536 = ".trim())) {" + NL + "\t\t\t\t\tif(!additionalJdbcSettings_";
  protected final String TEXT_537 = ".startsWith(\";\")) {" + NL + "\t\t\t\t\t\tadditionalJdbcSettings_";
  protected final String TEXT_538 = " = \";\" + additionalJdbcSettings_";
  protected final String TEXT_539 = ";" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\turl_";
  protected final String TEXT_540 = " += additionalJdbcSettings_";
  protected final String TEXT_541 = ";" + NL + "\t\t\t\t}";
  protected final String TEXT_542 = NL + "\t\t\t\tif(true) {" + NL + "\t\t\t\t\tthrow new java.lang.UnsupportedOperationException(\"Parquet is only supported if the distribution uses embedded Hive version 0.10 or later.\");" + NL + "\t\t\t\t}";
  protected final String TEXT_543 = NL + "\t\t\t\t\troutines.system.GetJarsToRegister getJarsToRegister_";
  protected final String TEXT_544 = " = new routines.system.GetJarsToRegister();";
  protected final String TEXT_545 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_546 = NL + "\tclass GetHiveJarsToRegister_";
  protected final String TEXT_547 = " extends routines.system.GetJarsToRegister {" + NL + "\t\t" + NL + "\t\tprivate String uploadJarToHDFS(String jar) throws Exception {" + NL + "\t\t\t";
  protected final String TEXT_548 = NL;
  protected final String TEXT_549 = NL + "        String username_";
  protected final String TEXT_550 = " = (";
  protected final String TEXT_551 = " != null && !\"\".equals(";
  protected final String TEXT_552 = ")) ? ";
  protected final String TEXT_553 = " : System.getProperty(\"user.name\");;" + NL + "        org.apache.hadoop.fs.FileSystem fs_";
  protected final String TEXT_554 = " = null;";
  protected final String TEXT_555 = NL + "        org.apache.hadoop.conf.Configuration conf_";
  protected final String TEXT_556 = " = new org.apache.hadoop.conf.Configuration(); " + NL + "        conf_";
  protected final String TEXT_557 = ".set(\"";
  protected final String TEXT_558 = "\", ";
  protected final String TEXT_559 = ");" + NL + "        ";
  protected final String TEXT_560 = NL + "            conf_";
  protected final String TEXT_561 = ".set(\"dfs.client.use.datanode.hostname\", \"true\");";
  protected final String TEXT_562 = NL + "        \t\tconf_";
  protected final String TEXT_563 = ".set(";
  protected final String TEXT_564 = " ,";
  protected final String TEXT_565 = ");" + NL + "        \t";
  protected final String TEXT_566 = NL + "            username_";
  protected final String TEXT_567 = " = null;" + NL + "    \t\tconf_";
  protected final String TEXT_568 = ".set(\"dfs.namenode.kerberos.principal\", ";
  protected final String TEXT_569 = ");" + NL + "    \t\t";
  protected final String TEXT_570 = NL + "    \t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(";
  protected final String TEXT_571 = ", ";
  protected final String TEXT_572 = ");" + NL + "    \t\t";
  protected final String TEXT_573 = NL + "\t\t\tconf_";
  protected final String TEXT_574 = ".set(\"hadoop.job.ugi\",username_";
  protected final String TEXT_575 = "+\",\"+username_";
  protected final String TEXT_576 = ");" + NL + "        \tfs_";
  protected final String TEXT_577 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_578 = ");";
  protected final String TEXT_579 = NL + "        \t" + NL + "        \tif(username_";
  protected final String TEXT_580 = " == null || \"\".equals(username_";
  protected final String TEXT_581 = ")){" + NL + "        \t\tfs_";
  protected final String TEXT_582 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_583 = ");" + NL + "        \t}else{" + NL + "        \t\tfs_";
  protected final String TEXT_584 = " = org.apache.hadoop.fs.FileSystem.get(new java.net.URI(conf_";
  protected final String TEXT_585 = ".get(\"";
  protected final String TEXT_586 = "\")),conf_";
  protected final String TEXT_587 = ",username_";
  protected final String TEXT_588 = ");" + NL + "        \t}\t";
  protected final String TEXT_589 = NL + "\t\t\t";
  protected final String TEXT_590 = NL + "\t\t\t" + NL + "\t\t\tString pathUsername_";
  protected final String TEXT_591 = " = username_";
  protected final String TEXT_592 = " == null ? org.apache.hadoop.security.UserGroupInformation.getLoginUser().getShortUserName() : username_";
  protected final String TEXT_593 = ";" + NL + "\t\t\tfs_";
  protected final String TEXT_594 = ".mkdirs(new org.apache.hadoop.fs.Path(\"/user/\" + pathUsername_";
  protected final String TEXT_595 = " + \"/tmp\"), new org.apache.hadoop.fs.permission.FsPermission(org.apache.hadoop.fs.permission.FsAction.ALL, org.apache.hadoop.fs.permission.FsAction.ALL, org.apache.hadoop.fs.permission.FsAction.ALL));" + NL + "\t\t\tfs_";
  protected final String TEXT_596 = ".copyFromLocalFile(false, true, new org.apache.hadoop.fs.Path(jar), new org.apache.hadoop.fs.Path(\"/user/\" + pathUsername_";
  protected final String TEXT_597 = " + \"/tmp\"));" + NL + "\t\t\treturn ";
  protected final String TEXT_598 = " + \"/user/\" + pathUsername_";
  protected final String TEXT_599 = " + \"/tmp/\" + new java.io.File(jar).getName();" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tpublic String replaceJarPaths(String originalClassPathLine) throws Exception {" + NL + "\t\t\tString classPathLine = super.replaceJarPaths(originalClassPathLine);" + NL + "\t\t\tString hdfsPath = uploadJarToHDFS(classPathLine);" + NL + "\t\t\treturn hdfsPath;" + NL + "\t\t}" + NL + "\t}" + NL + "\t\t\t\t\t\tGetHiveJarsToRegister_";
  protected final String TEXT_600 = " getJarsToRegister_";
  protected final String TEXT_601 = " = new GetHiveJarsToRegister_";
  protected final String TEXT_602 = "();";
  protected final String TEXT_603 = NL + "\t\t\t\t\tjava.sql.Statement addJar_";
  protected final String TEXT_604 = " = null;";
  protected final String TEXT_605 = NL + "\t\t\t\t\t\t\t\taddJar_";
  protected final String TEXT_606 = " = conn_";
  protected final String TEXT_607 = ".createStatement();" + NL + "\t\t\t\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t\t\t\taddJar_";
  protected final String TEXT_608 = ".execute(\"add jar \" + getJarsToRegister_";
  protected final String TEXT_609 = ".replaceJarPaths(\"";
  protected final String TEXT_610 = "\"));" + NL + "\t\t\t\t\t\t\t\t} catch (Exception e) {" + NL + "\t\t\t\t\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t\t\t\t\t} finally {" + NL + "\t\t\t\t\t\t\t\t\taddJar_";
  protected final String TEXT_611 = ".close();" + NL + "\t\t\t\t\t\t\t\t}";
  protected final String TEXT_612 = NL + "\tSystem.setProperty(\"org.apache.commons.logging.Log\", \"org.apache.commons.logging.impl.NoOpLog\");";
  protected final String TEXT_613 = NL + "\t\tSystem.setProperty(\"java.io.tmpdir\", ";
  protected final String TEXT_614 = ");";
  protected final String TEXT_615 = NL + "\tglobalMap.put(\"current_client_path_separator\", System.getProperty(\"path.separator\"));" + NL + "\tSystem.setProperty(\"path.separator\", ";
  protected final String TEXT_616 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_617 = NL + "\t\t    int nb_line_";
  protected final String TEXT_618 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_619 = " = null;";
  protected final String TEXT_620 = NL + "\t\t        conn_";
  protected final String TEXT_621 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_622 = "\");";
  protected final String TEXT_623 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_624 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_625 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_626 = " = dataSources_";
  protected final String TEXT_627 = ".get(";
  protected final String TEXT_628 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_633 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_634 = " =  conn_";
  protected final String TEXT_635 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_636 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_637 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_638 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_639 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_640 = NL + "                 conn_";
  protected final String TEXT_641 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_642 = NL + "               ";
  protected final String TEXT_643 = " + \"=\" + ";
  protected final String TEXT_644 = " + \";\" +";
  protected final String TEXT_645 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_646 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_647 = ");";
  protected final String TEXT_648 = NL + "\t\t    ";
  protected final String TEXT_649 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_650 = " = ";
  protected final String TEXT_651 = ";" + NL + "\t\t\t";
  protected final String TEXT_652 = NL + "                log.debug(\"";
  protected final String TEXT_653 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_654 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_655 = NL;
  protected final String TEXT_656 = NL + "                       globalMap.put(\"";
  protected final String TEXT_657 = "_QUERY\",dbquery_";
  protected final String TEXT_658 = ");";
  protected final String TEXT_659 = NL + "                       globalMap.put(\"";
  protected final String TEXT_660 = "_QUERY\",dbquery_";
  protected final String TEXT_661 = ");";
  protected final String TEXT_662 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_663 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_664 = " = stmt_";
  protected final String TEXT_665 = ".executeQuery(dbquery_";
  protected final String TEXT_666 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_667 = " = rs_";
  protected final String TEXT_668 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_669 = " = rsmd_";
  protected final String TEXT_670 = ".getColumnCount();" + NL;
  protected final String TEXT_671 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_672 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_673 = ".setDbmsId(\"";
  protected final String TEXT_674 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_675 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_676 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_677 = ".add(\"";
  protected final String TEXT_678 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_679 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_680 = " = ";
  protected final String TEXT_681 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_682 = "; i <= rsmd_";
  protected final String TEXT_683 = ".getColumnCount()-";
  protected final String TEXT_684 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_685 = ".contains(rsmd_";
  protected final String TEXT_686 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_687 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_688 = ".setName(rsmd_";
  protected final String TEXT_689 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_690 = ".setDbName(rsmd_";
  protected final String TEXT_691 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_692 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_693 = "\", rsmd_";
  protected final String TEXT_694 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_695 = ".getPrecision(i), rsmd_";
  protected final String TEXT_696 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_697 = ".setDbType(rsmd_";
  protected final String TEXT_698 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_699 = ".setDbTypeId(rsmd_";
  protected final String TEXT_700 = ".getColumnType(i));";
  protected final String TEXT_701 = NL + "                \tdcm_";
  protected final String TEXT_702 = ".setFormat(";
  protected final String TEXT_703 = ");";
  protected final String TEXT_704 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_705 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_706 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_707 = ".setLength(rsmd_";
  protected final String TEXT_708 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_709 = ".setLength(rsmd_";
  protected final String TEXT_710 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_711 = NL + "\t\t\tdcm_";
  protected final String TEXT_712 = ".setLength(rsmd_";
  protected final String TEXT_713 = ".getPrecision(i));";
  protected final String TEXT_714 = NL + "                \tdcm_";
  protected final String TEXT_715 = ".setPrecision(rsmd_";
  protected final String TEXT_716 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_717 = ".setNullable(rsmd_";
  protected final String TEXT_718 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_719 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_720 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_721 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_722 = ".metadatas.add(dcm_";
  protected final String TEXT_723 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_724 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_725 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_726 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_727 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_728 = NL + "\t\t    ";
  protected final String TEXT_729 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_730 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_731 = NL + "\t\t    while (rs_";
  protected final String TEXT_732 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_733 = "++;" + NL + "\t\t        ";
  protected final String TEXT_734 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_735 = " = ";
  protected final String TEXT_736 = " + dcg_";
  protected final String TEXT_737 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_738 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_739 = " = ";
  protected final String TEXT_740 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_741 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_742 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_743 = " < ";
  protected final String TEXT_744 = "column_index_";
  protected final String TEXT_745 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_746 = ".";
  protected final String TEXT_747 = " = ";
  protected final String TEXT_748 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  ...
  protected final String TEXT_754 = " = (List)rs_";
  protected final String TEXT_755 = ".getObject(";
  protected final String TEXT_756 = "column_index_";
  protected final String TEXT_757 = ");";
  protected final String TEXT_758 = NL + "\t                         \t\t";
  protected final String TEXT_759 = NL + "\t                         \t\t";
  protected final String TEXT_760 = NL + "\t                         \t\t";
  protected final String TEXT_761 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_762 = ".getObject(";
  protected final String TEXT_763 = "column_index_";
  protected final String TEXT_764 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_765 = NL + "                                    ";
  protected final String TEXT_766 = ".";
  protected final String TEXT_767 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_776 = ".setEPSG(";
  protected final String TEXT_777 = ");" + NL + "                                        }";
  protected final String TEXT_778 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_779 = NL + "                                  ";
  protected final String TEXT_780 = ".";
  protected final String TEXT_781 = "=dcg_";
  protected final String TEXT_782 = ";";
  protected final String TEXT_783 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_784 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_785 = " = ";
  protected final String TEXT_786 = "; i_";
  protected final String TEXT_787 = "  <= rsmd_";
  protected final String TEXT_788 = ".getColumnCount(); i_";
  protected final String TEXT_789 = " ++){" + NL + "\t\t\t\t\t    \t\t\t\t\t";
  protected final String TEXT_790 = NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_791 = ".getColumnTypeName(i_";
  protected final String TEXT_792 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_793 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_794 = ".getClob(i_";
  protected final String TEXT_795 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_796 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_797 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_798 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_799 = ".add(tNTextImpl_";
  protected final String TEXT_800 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_801 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_802 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_803 = ".getColumnTypeName(i_";
  protected final String TEXT_804 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_805 = ".add(rs_";
  protected final String TEXT_806 = ".getString(i_";
  protected final String TEXT_807 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_808 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_809 = ".";
  protected final String TEXT_810 = ", rs_";
  protected final String TEXT_811 = ", fixedColumnCount_";
  protected final String TEXT_812 = ",list_";
  protected final String TEXT_813 = ",";
  protected final String TEXT_814 = ");";
  protected final String TEXT_815 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_816 = ".";
  protected final String TEXT_817 = ", rs_";
  protected final String TEXT_818 = ", fixedColumnCount_";
  protected final String TEXT_819 = ",";
  protected final String TEXT_820 = ");";
  protected final String TEXT_821 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_822 = ".";
  protected final String TEXT_823 = ", rs_";
  protected final String TEXT_824 = ", fixedColumnCount_";
  protected final String TEXT_825 = ",";
  protected final String TEXT_826 = ");";
  protected final String TEXT_827 = NL + "                                  Object geom = rs_";
  protected final String TEXT_828 = ".getObject(";
  protected final String TEXT_829 = "column_index_";
  protected final String TEXT_830 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_831 = ".";
  protected final String TEXT_832 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_838 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_839 = " - Retrieving the record \" + nb_line_";
