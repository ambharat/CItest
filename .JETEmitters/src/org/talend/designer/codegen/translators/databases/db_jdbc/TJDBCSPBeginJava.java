...
public class TJDBCSPBeginJava
{
  ...
  protected final String TEXT_50 = " " + NL + "\t\tif (null == connection_";
  protected final String TEXT_51 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_52 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES); " + NL + "\t\t\tconnection_";
  protected final String TEXT_53 = " = dataSources_";
  protected final String TEXT_54 = ".get(";
  protected final String TEXT_55 = ").getConnection();" + NL + "\t\t}";
  protected final String TEXT_56 = NL + "\tjava.sql.Connection connection_";
  ...
  protected final String TEXT_78 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_79 = ", ";
  protected final String TEXT_80 = ", decryptedPassword_";
  protected final String TEXT_81 = ");" + NL + "\t\t\t";
  protected final String TEXT_82 = NL + "\t";
  protected final String TEXT_83 = NL + "\t\t}";
  protected final String TEXT_84 = NL + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_85 = " = connection_";
  protected final String TEXT_86 = ".prepareCall(\"{";
  protected final String TEXT_87 = "call \" + ";
  protected final String TEXT_88 = " + \"(";
  protected final String TEXT_89 = "?";
  protected final String TEXT_90 = ",?";
  protected final String TEXT_91 = ")}\");" + NL + "" + NL + "java.sql.Date tmpDate_";
  protected final String TEXT_92 = ";" + NL + "String tmpString_";
