...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_97 = ").getConnection();" + NL + "\t\t} else {";
  protected final String TEXT_98 = NL + "\t\tString dbProperties_";
  protected final String TEXT_99 = " = ";
  protected final String TEXT_100 = ";" + NL + "\t\tString url_";
  protected final String TEXT_101 = " = null;" + NL + "\t\tif(dbProperties_";
  protected final String TEXT_102 = " == null || dbProperties_";
  protected final String TEXT_103 = ".trim().length() == 0) {" + NL + "\t\t\turl_";
  protected final String TEXT_104 = " = \"";
  protected final String TEXT_105 = "://\" + ";
  protected final String TEXT_106 = " + \":\" + ";
  protected final String TEXT_107 = " + \"/\" + ";
  protected final String TEXT_108 = " + \"?\" + \"rewriteBatchedStatements=true\";" + NL + "\t\t} else {" + NL + "\t\t\tString properties_";
  protected final String TEXT_109 = " = ";
  protected final String TEXT_110 = ";" + NL + "\t\t\tif (!properties_";
  protected final String TEXT_111 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\t\tproperties_";
  protected final String TEXT_112 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\turl_";
  protected final String TEXT_113 = " = \"";
  protected final String TEXT_114 = "://\" + ";
  protected final String TEXT_115 = " + \":\" + ";
  protected final String TEXT_116 = " + \"/\" + ";
  protected final String TEXT_117 = " + \"?\" + properties_";
  protected final String TEXT_118 = ";" + NL + "\t\t}" + NL + "\t\tString driverClass_";
  ...
  protected final String TEXT_133 = ";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_142 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_143 = "\", conn_";
  protected final String TEXT_144 = ");";
  protected final String TEXT_145 = NL + "        conn_";
  protected final String TEXT_146 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_147 = " = ";
  protected final String TEXT_148 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_149 = " = 0;";
  protected final String TEXT_150 = NL + "   int batchSize_";
  protected final String TEXT_151 = " = ";
  protected final String TEXT_152 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_153 = "=0;";
  protected final String TEXT_154 = NL;
  protected final String TEXT_155 = NL + "int count_";
  ...
  protected final String TEXT_162 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_210 = NL + "                    String keyCheckTable_";
  protected final String TEXT_211 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_218 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_219 = " = conn_";
  protected final String TEXT_220 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_221 = " + \"]\";";
  protected final String TEXT_222 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_223 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_224 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_225 = ")== null){//}";
  protected final String TEXT_226 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_227 = " = conn_";
  protected final String TEXT_228 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_229 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_230 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_231 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_232 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_233 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_238 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_239 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_240 = " = tableNameForSearch_";
  protected final String TEXT_241 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_242 = " = tableNameForSearch_";
  protected final String TEXT_243 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_244 = " = dbMetaData_";
  protected final String TEXT_245 = ".getTables(null, dbschemaForSearch_";
  ...
  protected final String TEXT_271 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_295 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_296 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_305 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_306 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_307 = " == null || dbschema_";
  protected final String TEXT_308 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_309 = " = conn_";
  protected final String TEXT_310 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_311 = " = stmtSchema_";
  protected final String TEXT_312 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_313 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_314 = " = rsSchema_";
  protected final String TEXT_315 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_316 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_317 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_318 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_319 = " = rsTable_";
  protected final String TEXT_320 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_321 = " = rsTable_";
  protected final String TEXT_322 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_323 = ".equals";
  protected final String TEXT_324 = "IgnoreCase";
  protected final String TEXT_325 = "(";
  protected final String TEXT_326 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_331 = " ==null || dbschema_";
  protected final String TEXT_332 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_333 = ".equals";
  protected final String TEXT_334 = "IgnoreCase";
  protected final String TEXT_335 = "(schema_";
  ...
  protected final String TEXT_353 = ".getTables(null, conn_";
  protected final String TEXT_354 = ".getSchema(), tableForSearch_";
  protected final String TEXT_355 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_356 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_357 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_358 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_365 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_366 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_367 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_368 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_504 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_505 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_506 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_507 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_508 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_509 = ".append (\"`\" +  ";
  protected final String TEXT_510 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_511 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_548 = NL + "\t            class BufferLine_";
  protected final String TEXT_549 = " {" + NL + "    \t            ";
  protected final String TEXT_550 = NL + "                            ";
  protected final String TEXT_551 = " ";
  protected final String TEXT_552 = ";";
  protected final String TEXT_553 = NL + NL + "\t                public BufferLine_";
  ...
  protected final String TEXT_562 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_563 = "> exInsertColValueList";
  protected final String TEXT_564 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_565 = " exInsertColValue";
  protected final String TEXT_566 = " = null;" + NL + "" + NL + "" + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_567 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_568 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_569 = ".append(\"(";
  protected final String TEXT_570 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_571 = "-1) extendInsertValueStmt_";
  protected final String TEXT_572 = ".append(\",\");" + NL + "                }" + NL + "" + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_573 = " = \"INSERT INTO `\"+";
  protected final String TEXT_574 = "+\"` (";
  protected final String TEXT_575 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_576 = ".toString();";
  protected final String TEXT_577 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_578 = " += \tduplidateClause_";
  ...
  protected final String TEXT_592 = ");" + NL + "" + NL + "\t            String insertColName";
  protected final String TEXT_593 = " = \"";
  protected final String TEXT_594 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_595 = " =  \"";
  protected final String TEXT_596 = "\";" + NL + "\t            int rowCount";
  ...
  protected final String TEXT_604 = " += \tduplidateClause_";
  protected final String TEXT_605 = ".toString();";
  protected final String TEXT_606 = NL + "\t\t        int batchSize_";
  protected final String TEXT_607 = " = ";
  protected final String TEXT_608 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_609 = "=0;" + NL + "\t\t        ";
  ...
  protected final String TEXT_660 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_672 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_677 = " = \"UPDATE `\" + ";
  protected final String TEXT_678 = " + \"` SET ";
  protected final String TEXT_679 = " WHERE ";
  protected final String TEXT_680 = "\";" + NL + "\t    ";
  protected final String TEXT_681 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_682 = " = new StringBuffer(update_";
  protected final String TEXT_683 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_684 = ".insert(update_";
  protected final String TEXT_685 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_686 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_687 = " =updateStringBuffer_";
  protected final String TEXT_688 = ".toString(); ";
  protected final String TEXT_689 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_690 = " = conn_";
  protected final String TEXT_691 = ".prepareStatement(update_";
  protected final String TEXT_692 = ");" + NL + "\t    String insert_";
  protected final String TEXT_693 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_705 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_709 = NL + "\t    String delete_";
  protected final String TEXT_710 = " = \"DELETE FROM `\" + ";
  protected final String TEXT_711 = " + \"` WHERE ";
  protected final String TEXT_712 = "\";" + NL + "\t    ";
  protected final String TEXT_713 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_714 = " = new StringBuffer(delete_";
  protected final String TEXT_715 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_716 = ".insert(delete_";
  protected final String TEXT_717 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_718 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_719 = " =deleteStringBuffer_";
  protected final String TEXT_720 = ".toString();  ";
  protected final String TEXT_721 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_722 = " = conn_";
  protected final String TEXT_723 = ".prepareStatement(delete_";
  protected final String TEXT_724 = ");" + NL + "\t    ";
  protected final String TEXT_725 = NL + "\t    String replace_";
  protected final String TEXT_726 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_727 = " + \"` (";
  protected final String TEXT_728 = ") VALUES (";
  protected final String TEXT_729 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_730 = " = conn_";
  protected final String TEXT_731 = ".prepareStatement(replace_";
  protected final String TEXT_732 = ");" + NL + "\t    ";
  protected final String TEXT_733 = NL + "\t    String insertIgnore_";
  protected final String TEXT_734 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_735 = " + \"` (";
  protected final String TEXT_736 = ") VALUES (";
  protected final String TEXT_737 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_738 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_739 = " = conn_";
  protected final String TEXT_740 = ".prepareStatement(insertIgnore_";
  ...
  protected final String TEXT_759 = NL + "        StringBuffer query_";
  protected final String TEXT_760 = " = null;" + NL + "       \t";
  ...
  protected final String TEXT_783 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_784 = " = insertIgnore_";
  protected final String TEXT_785 = ".split(\"\\\\?\");";
  protected final String TEXT_786 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_787 = " = insert_";
  protected final String TEXT_788 = ".split(\"\\\\?\");";
  protected final String TEXT_789 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_790 = " {" + NL + "    \t            ";
  protected final String TEXT_791 = NL + "                            ";
  protected final String TEXT_792 = " ";
  protected final String TEXT_793 = ";";
  protected final String TEXT_794 = NL + "\t\t\t\troutines.system.Dynamic ";
  protected final String TEXT_795 = ";" + NL + "\t\t\t";
  protected final String TEXT_796 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_797 = "(";
  protected final String TEXT_798 = NL + "                                ,";
  protected final String TEXT_799 = NL + "                            ";
  protected final String TEXT_800 = " ";
  protected final String TEXT_801 = NL + "\t\t\t\t, routines.system.Dynamic ";
  protected final String TEXT_802 = NL + "\t\t\t";
  protected final String TEXT_803 = NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_804 = NL + "                                this.";
  protected final String TEXT_805 = " = ";
  protected final String TEXT_806 = ";";
  protected final String TEXT_807 = NL + "\t\t\t\tthis.";
  protected final String TEXT_808 = "=";
  protected final String TEXT_809 = ";" + NL + "\t\t\t";
  protected final String TEXT_810 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_811 = "> exInsertColValueList";
  protected final String TEXT_812 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_813 = " exInsertColValue";
  protected final String TEXT_814 = " = null;" + NL + "\t\t    String insert_";
  protected final String TEXT_815 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_816 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_817 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_818 = "=1;";
  protected final String TEXT_819 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_820 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_821 = "=0;";
  protected final String TEXT_822 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_823 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_824 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_825 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_826 = "=0;" + NL + "\t";
  protected final String TEXT_827 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_828 = " = null;" + NL + "\t\t";
  protected final String TEXT_829 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_830 = " = null;";
  protected final String TEXT_831 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_832 = " =  null;";
  protected final String TEXT_833 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_834 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_835 = " = null;";
  protected final String TEXT_836 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_837 = " = null;";
  protected final String TEXT_838 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_839 = " = null;";
  protected final String TEXT_840 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_841 = " = null;";
  protected final String TEXT_842 = NL + "\t\t \tString[] insertSQLSplits_";
