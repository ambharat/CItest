...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_1071 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1086 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1087 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1088 = NL + "                \tint countSum_";
  protected final String TEXT_1089 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1090 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1103 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1104 = NL + "                }" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1105 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1106 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1107 = " <= commitCounter_";
  protected final String TEXT_1108 = ") {";
  protected final String TEXT_1109 = NL + "                if ((batchSize_";
  protected final String TEXT_1110 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1111 = " > 0)) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_1112 = " = 0;" + NL + "                \t\tint countSum_";
  protected final String TEXT_1113 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_1114 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1115 = ": pstmt_";
  protected final String TEXT_1116 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1117 = " += (countEach_";
  protected final String TEXT_1118 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1122 = " += countSum_";
  protected final String TEXT_1123 = ";" + NL + "            \t    \t";
  protected final String TEXT_1124 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1125 = " += countSum_";
  protected final String TEXT_1126 = ";" + NL + "            \t    \t";
  protected final String TEXT_1127 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1128 = " += countSum_";
  protected final String TEXT_1129 = ";" + NL + "            \t    \t";
  protected final String TEXT_1130 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1131 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1132 = NL + "                \t\tint countSum_";
  protected final String TEXT_1133 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1134 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1135 = " += (countEach_";
  protected final String TEXT_1136 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1141 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1142 = " += countSum_";
  protected final String TEXT_1143 = ";" + NL + "            \t    \t";
  protected final String TEXT_1144 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1145 = " += countSum_";
  protected final String TEXT_1146 = ";" + NL + "            \t    \t";
  protected final String TEXT_1147 = NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1148 = NL + "                }" + NL + "                }";
  protected final String TEXT_1149 = NL + "                \t";
  protected final String TEXT_1150 = NL + "                \tconn_";
  protected final String TEXT_1151 = ".commit();" + NL + "                \t";
