...
public class TDB2SPBeginJava
{
  ...
  protected final String TEXT_52 = NL + "\tif (null == connection_";
  protected final String TEXT_53 = ") {" + NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_54 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tconnection_";
  protected final String TEXT_55 = " = dataSources_";
  protected final String TEXT_56 = ".get(";
  protected final String TEXT_57 = ").getConnection();" + NL + "\t}";
  ...
  protected final String TEXT_63 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_64 = NL + "\t    String url_";
  protected final String TEXT_65 = " = \"jdbc:db2://\" + ";
  ...
  protected final String TEXT_75 = NL + "java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");";
  ...
  protected final String TEXT_83 = NL + "connection_";
  ...
  protected final String TEXT_89 = NL + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_90 = " = connection_";
  protected final String TEXT_91 = ".prepareCall(\"{";
  protected final String TEXT_92 = "call \" + ";
  protected final String TEXT_93 = " + \"(";
  protected final String TEXT_94 = "?";
  protected final String TEXT_95 = ",?";
  protected final String TEXT_96 = ")}\");" + NL + "" + NL + "java.sql.Date tmpDate_";
  protected final String TEXT_97 = ";" + NL + "String tmpString_";
