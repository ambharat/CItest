...
public class TTeradataConnectionBeginJava
{
  ...
  protected final String TEXT_176 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_184 = NL + "\tif (null != conn_";
  protected final String TEXT_185 = ") {" + NL + "\t\t";
  protected final String TEXT_186 = NL + "\t}";
  protected final String TEXT_187 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_188 = "\",conn_";
  protected final String TEXT_189 = ");" + NL + "\tglobalMap.put(\"host_";
  protected final String TEXT_190 = "\", ";
  protected final String TEXT_191 = ");" + NL + "\tglobalMap.put(\"dbname_";
  protected final String TEXT_192 = "\", ";
  protected final String TEXT_193 = ");" + NL + "\tglobalMap.put(\"username_";
  protected final String TEXT_194 = "\", dbUser_";
  protected final String TEXT_195 = ");" + NL + "\tglobalMap.put(\"password_";
  protected final String TEXT_196 = "\", dbPwd_";
  protected final String TEXT_197 = ");" + NL + "\tglobalMap.put(\"url_";
  protected final String TEXT_198 = "\", url_";
