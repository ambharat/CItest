...
public class TMSSqlInputBeginJava
{
  ...
  protected final String TEXT_189 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_190 = " ;";
  protected final String TEXT_191 = "\t\t    " + NL + "\t\t    String url_";
  protected final String TEXT_192 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_193 = " ;";
  protected final String TEXT_194 = NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_195 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_196 = " += \":\" + ";
  protected final String TEXT_197 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_198 = ")) {";
  protected final String TEXT_199 = NL + "\t\t\t\turl_";
  protected final String TEXT_200 = " += \"//\" + ";
  protected final String TEXT_201 = "; ";
  protected final String TEXT_202 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_203 = " += \";databaseName=\" + ";
  ...
  protected final String TEXT_212 = " = mssqlGTU_";
  protected final String TEXT_213 = ".getDate(rsmd_";
  protected final String TEXT_214 = ", rs_";
  protected final String TEXT_215 = ", ";
  protected final String TEXT_216 = "column_index_";
  protected final String TEXT_217 = ");" + NL + "\t\t\t";
  protected final String TEXT_218 = NL + "\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_219 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_220 = ".getClob(";
  ...
  protected final String TEXT_224 = ");" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_225 = " = tNTextImpl_";
  protected final String TEXT_226 = ".getValue();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_227 = " = null;\t\t\t\t" + NL + "\t\t\t\t}";
  protected final String TEXT_228 = NL + "           \t\ttmpContent_";
  protected final String TEXT_229 = " = rs_";
  protected final String TEXT_230 = ".getString(";
  protected final String TEXT_231 = "column_index_";
  protected final String TEXT_232 = ");";
  protected final String TEXT_233 = NL + "            if(tmpContent_";
  protected final String TEXT_234 = " != null) {" + NL + "            \tif (talendToDBList_";
  protected final String TEXT_235 = " .contains(rsmd_";
  protected final String TEXT_236 = ".getColumnTypeName(";
  protected final String TEXT_237 = "column_index_";
  protected final String TEXT_238 = ").toUpperCase(java.util.Locale.ENGLISH))) {" + NL + "            \t\t";
  protected final String TEXT_239 = ".";
  protected final String TEXT_240 = " = FormatterUtils.formatUnwithE(tmpContent_";
  protected final String TEXT_241 = ");" + NL + "            \t} else {" + NL + "                \t";
  protected final String TEXT_242 = ".";
  protected final String TEXT_243 = " = tmpContent_";
  protected final String TEXT_244 = ";" + NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_265 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_266 = " =  conn_";
  protected final String TEXT_267 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_268 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_269 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_270 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_271 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_272 = NL + "                 conn_";
  protected final String TEXT_273 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_274 = NL + "               ";
  protected final String TEXT_275 = " + \"=\" + ";
  protected final String TEXT_276 = " + \";\" +";
  protected final String TEXT_277 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_278 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_279 = ");";
  protected final String TEXT_280 = NL + "\t\t    ";
  protected final String TEXT_281 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_282 = " = ";
  protected final String TEXT_283 = ";" + NL + "\t\t\t";
  protected final String TEXT_284 = NL + "                log.debug(\"";
  protected final String TEXT_285 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_294 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_295 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_296 = " = stmt_";
  protected final String TEXT_297 = ".executeQuery(dbquery_";
  protected final String TEXT_298 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_299 = " = rs_";
  protected final String TEXT_300 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_301 = " = rsmd_";
  protected final String TEXT_302 = ".getColumnCount();" + NL;
  protected final String TEXT_303 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_304 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_305 = ".setDbmsId(\"";
  protected final String TEXT_306 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_307 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_308 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_309 = ".add(\"";
  protected final String TEXT_310 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_311 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_312 = " = ";
  protected final String TEXT_313 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_314 = "; i <= rsmd_";
  protected final String TEXT_315 = ".getColumnCount()-";
  protected final String TEXT_316 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_317 = ".contains(rsmd_";
  protected final String TEXT_318 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_319 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_320 = ".setName(rsmd_";
  protected final String TEXT_321 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_322 = ".setDbName(rsmd_";
  protected final String TEXT_323 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_324 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_325 = "\", rsmd_";
  protected final String TEXT_326 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_327 = ".getPrecision(i), rsmd_";
  protected final String TEXT_328 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_329 = ".setDbType(rsmd_";
  protected final String TEXT_330 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_331 = ".setDbTypeId(rsmd_";
  protected final String TEXT_332 = ".getColumnType(i));";
  ...
  protected final String TEXT_362 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_363 = NL + "\t\t    while (rs_";
  protected final String TEXT_364 = ".next()) {" + NL + "\t\t        nb_line_";
  ...
  protected final String TEXT_374 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_375 = " < ";
  protected final String TEXT_376 = "column_index_";
  protected final String TEXT_377 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_378 = ".";
  protected final String TEXT_379 = " = ";
  protected final String TEXT_380 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  protected final String TEXT_381 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_382 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_383 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_384 = NL + "\t\t                            ";
  protected final String TEXT_385 = ".";
  protected final String TEXT_386 = " = (List)rs_";
  ...
  protected final String TEXT_393 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_394 = ".getObject(";
  protected final String TEXT_395 = "column_index_";
  protected final String TEXT_396 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_397 = NL + "                                    ";
  protected final String TEXT_398 = ".";
  protected final String TEXT_399 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_433 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_434 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_435 = ".getColumnTypeName(i_";
  protected final String TEXT_436 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_437 = ".add(rs_";
  protected final String TEXT_438 = ".getString(i_";
  protected final String TEXT_439 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_440 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_447 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_448 = ".";
  protected final String TEXT_449 = ", rs_";
  protected final String TEXT_450 = ", fixedColumnCount_";
  protected final String TEXT_451 = ",";
  protected final String TEXT_452 = ");";
  protected final String TEXT_453 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_454 = ".";
  protected final String TEXT_455 = ", rs_";
  protected final String TEXT_456 = ", fixedColumnCount_";
  protected final String TEXT_457 = ",";
  protected final String TEXT_458 = ");";
  protected final String TEXT_459 = NL + "                                  Object geom = rs_";
  protected final String TEXT_460 = ".getObject(";
  protected final String TEXT_461 = "column_index_";
  protected final String TEXT_462 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_463 = ".";
  protected final String TEXT_464 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_471 = " - Retrieving the record \" + nb_line_";
