...
public class TMysqlSPBeginJava
{
  ...
  protected final String TEXT_57 = ").getConnection();" + NL + "\t\t}" + NL + "\t";
  ...
  protected final String TEXT_64 = NL + "    String dbProperties_";
  ...
  protected final String TEXT_69 = ".trim().length() == 0) {" + NL + "        connectionString_";
  protected final String TEXT_70 = " = \"";
  protected final String TEXT_71 = "://\" + ";
  protected final String TEXT_72 = " + \":\" + ";
  protected final String TEXT_73 = " + \"/\" + ";
  protected final String TEXT_74 = ";" + NL + "    } else {" + NL + "        connectionString_";
  ...
  protected final String TEXT_92 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"";
  ...
  protected final String TEXT_100 = NL + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_101 = " = connection_";
  protected final String TEXT_102 = ".prepareCall(\"{";
  protected final String TEXT_103 = "call \" + ";
