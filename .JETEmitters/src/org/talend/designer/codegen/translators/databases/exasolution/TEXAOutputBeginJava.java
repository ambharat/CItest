...
public class TEXAOutputBeginJava {
  ...
  protected final String TEXT_84 = NL + "        if (null == conn_";
  protected final String TEXT_85 = ") {" + NL + "            java.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_86 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "            conn_";
  protected final String TEXT_87 = " = dataSources_";
  protected final String TEXT_88 = ".get(";
  protected final String TEXT_89 = ").getConnection();" + NL + "        }";
  ...
  protected final String TEXT_97 = NL + "    java.lang.Class.forName(\"com.exasol.jdbc.EXADriver\");" + NL + "    String url_";
  ...
  protected final String TEXT_540 = NL + "        StringBuffer query_";
  protected final String TEXT_541 = " = null;";
  protected final String TEXT_542 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_571 = " =null;" + NL + "    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_572 = " =null;" + NL + "    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_581 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
