...
public class TTeradataInputBeginJava
{
  ...
  protected final String TEXT_373 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_374 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_375 = ".getColumnTypeName(i_";
  protected final String TEXT_376 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_377 = ".add(rs_";
  protected final String TEXT_378 = ".getString(i_";
  protected final String TEXT_379 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_380 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_399 = NL + "                                  Object geom = rs_";
  protected final String TEXT_400 = ".getObject(";
  protected final String TEXT_401 = "column_index_";
  protected final String TEXT_402 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_403 = ".";
  protected final String TEXT_404 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
