...
public class THiveConnectionBeginJava
{
  ...
  protected final String TEXT_387 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_388 = ")) {";
  protected final String TEXT_389 = NL + "\t\t";
  protected final String TEXT_390 = NL + "\t\t";
  protected final String TEXT_391 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_392 = "\", conn_";
  protected final String TEXT_393 = ");";
  protected final String TEXT_394 = NL + "\t}";
  protected final String TEXT_395 = NL + "\tif (null != conn_";
  protected final String TEXT_396 = ") {" + NL + "\t\t";
  protected final String TEXT_397 = NL + "\t}";
  protected final String TEXT_398 = NL;
  protected final String TEXT_399 = NL + "\tglobalMap.put(\"current_client_path_separator\", System.getProperty(\"path.separator\"));" + NL + "\tSystem.setProperty(\"path.separator\", ";
  protected final String TEXT_400 = ");" + NL + "" + NL + "\tjava.sql.Statement init_";
  ...
  protected final String TEXT_404 = ".execute(\"SET mapred.job.map.memory.mb=\" + ";
  protected final String TEXT_405 = ");" + NL + "\t    init_";
  protected final String TEXT_406 = ".execute(\"SET mapred.job.reduce.memory.mb=\" + ";
  protected final String TEXT_407 = ");";
  protected final String TEXT_408 = NL + "\t\tinit_";
  protected final String TEXT_409 = ".execute(\"SET dfs.namenode.kerberos.principal=\" + ";
  protected final String TEXT_410 = ");";
  protected final String TEXT_411 = NL + "\t\t\tinit_";
  protected final String TEXT_412 = ".execute(\"SET mapreduce.jobtracker.kerberos.principal=\" + ";
  protected final String TEXT_413 = ");";
  protected final String TEXT_414 = NL + "\t\t\tinit_";
  protected final String TEXT_415 = ".execute(\"SET yarn.resourcemanager.principal=\" + ";
  protected final String TEXT_416 = ");";
  protected final String TEXT_417 = NL + "    \t\tinit_";
  protected final String TEXT_418 = ".execute(\"SET mapreduce.framework.name=yarn\");" + NL + "    \t\tinit_";
  protected final String TEXT_419 = ".execute(\"SET yarn.resourcemanager.address=\" + ";
  protected final String TEXT_420 = ");";
  protected final String TEXT_421 = NL + "\t\t\tinit_";
  protected final String TEXT_422 = ".execute(\"SET mapreduce.jobhistory.address=\" + ";
  protected final String TEXT_423 = ");" + NL + "\t\t\t";
  protected final String TEXT_424 = NL + "\t\t\tinit_";
  protected final String TEXT_425 = ".execute(\"SET dfs.client.use.datanode.hostname=true\");";
  protected final String TEXT_426 = NL + "\t\t\tinit_";
  protected final String TEXT_427 = ".execute(\"SET yarn.resourcemanager.scheduler.address=\" + ";
  protected final String TEXT_428 = ");";
  protected final String TEXT_429 = NL + "\t\t\tinit_";
  protected final String TEXT_430 = ".execute(\"SET fs.default.name=\" + ";
  protected final String TEXT_431 = ");";
  protected final String TEXT_432 = NL + "\t\t\t\tinit_";
  protected final String TEXT_433 = ".execute(\"SET mapreduce.app-submission.cross-platform=true\");";
  protected final String TEXT_434 = NL + "\t\t\t\tinit_";
  protected final String TEXT_435 = ".execute(\"SET mapreduce.job.map.output.collector.class=org.apache.hadoop.mapred.MapRFsOutputBuffer\");" + NL + "\t\t\t\tinit_";
  protected final String TEXT_436 = ".execute(\"SET mapreduce.job.reduce.shuffle.consumer.plugin.class=org.apache.hadoop.mapreduce.task.reduce.DirectShuffle\");";
  protected final String TEXT_437 = NL + "\t\t\t\tinit_";
  protected final String TEXT_438 = ".execute(\"SET mapreduce.application.classpath=";
  protected final String TEXT_439 = "\");";
  protected final String TEXT_440 = NL + "\t\t\tinit_";
  protected final String TEXT_441 = ".execute(\"SET yarn.application.classpath=";
  protected final String TEXT_442 = "\");";
  protected final String TEXT_443 = NL + "\t\t\tinit_";
  protected final String TEXT_444 = ".execute(\"SET mapreduce.map.memory.mb=\" + ";
  protected final String TEXT_445 = ");" + NL + "\t\t\tinit_";
  protected final String TEXT_446 = ".execute(\"SET mapreduce.reduce.memory.mb=\" + ";
  protected final String TEXT_447 = ");" + NL + "\t\t\tinit_";
  protected final String TEXT_448 = ".execute(\"SET yarn.app.mapreduce.am.resource.mb=\" + ";
  protected final String TEXT_449 = ");";
  protected final String TEXT_450 = NL + "\t\t\tinit_";
  protected final String TEXT_451 = ".execute(\"SET \"+";
  ...
  protected final String TEXT_457 = ".execute(\"SET hive.execution.engine=tez\");";
  protected final String TEXT_458 = NL + "                        System.err.println(\"Please set the path of Tez lib in 'Tez lib path'!\");";
  protected final String TEXT_459 = NL;
  protected final String TEXT_460 = NL + "        String username_";
  protected final String TEXT_461 = " = (";
  protected final String TEXT_462 = " != null && !\"\".equals(";
  protected final String TEXT_463 = ")) ? ";
  protected final String TEXT_464 = " : System.getProperty(\"user.name\");;" + NL + "        org.apache.hadoop.fs.FileSystem fs_";
  protected final String TEXT_465 = " = null;";
  protected final String TEXT_466 = NL + "        org.apache.hadoop.conf.Configuration conf_";
  protected final String TEXT_467 = " = new org.apache.hadoop.conf.Configuration(); " + NL + "        conf_";
  protected final String TEXT_468 = ".set(\"";
  protected final String TEXT_469 = "\", ";
  protected final String TEXT_470 = ");" + NL + "        ";
  protected final String TEXT_471 = NL + "            conf_";
  protected final String TEXT_472 = ".set(\"dfs.client.use.datanode.hostname\", \"true\");";
  protected final String TEXT_473 = NL + "        \t\tconf_";
  protected final String TEXT_474 = ".set(";
  protected final String TEXT_475 = " ,";
  protected final String TEXT_476 = ");" + NL + "        \t";
  protected final String TEXT_477 = NL + "            username_";
  protected final String TEXT_478 = " = null;" + NL + "    \t\tconf_";
  protected final String TEXT_479 = ".set(\"dfs.namenode.kerberos.principal\", ";
  protected final String TEXT_480 = ");" + NL + "    \t\t";
  protected final String TEXT_481 = NL + "    \t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(";
  protected final String TEXT_482 = ", ";
  protected final String TEXT_483 = ");" + NL + "    \t\t";
  protected final String TEXT_484 = NL + "\t\t\tconf_";
  protected final String TEXT_485 = ".set(\"hadoop.job.ugi\",username_";
  protected final String TEXT_486 = "+\",\"+username_";
  protected final String TEXT_487 = ");" + NL + "        \tfs_";
  protected final String TEXT_488 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_489 = ");";
  protected final String TEXT_490 = NL + "        \t" + NL + "        \tif(username_";
  protected final String TEXT_491 = " == null || \"\".equals(username_";
  protected final String TEXT_492 = ")){" + NL + "        \t\tfs_";
  protected final String TEXT_493 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_494 = ");" + NL + "        \t}else{" + NL + "        \t\tfs_";
  protected final String TEXT_495 = " = org.apache.hadoop.fs.FileSystem.get(new java.net.URI(conf_";
  protected final String TEXT_496 = ".get(\"";
  protected final String TEXT_497 = "\")),conf_";
  protected final String TEXT_498 = ",username_";
  protected final String TEXT_499 = ");" + NL + "        \t}\t";
  protected final String TEXT_500 = NL + "                    String hdfsUserName_";
  protected final String TEXT_501 = " = (";
  protected final String TEXT_502 = " != null && !\"\".equals(";
  protected final String TEXT_503 = ")) ? ";
  protected final String TEXT_504 = " : System.getProperty(\"user.name\");" + NL + "                    String tezLibPath_";
  protected final String TEXT_505 = " = \"/tmp/\" + hdfsUserName_";
  protected final String TEXT_506 = " + \"/talend_tez_libs/";
  protected final String TEXT_507 = "\";";
  protected final String TEXT_508 = NL + "                    String tezLibPath_";
  protected final String TEXT_509 = " = ";
  protected final String TEXT_510 = ";";
  protected final String TEXT_511 = NL + "                fs_";
  protected final String TEXT_512 = ".mkdirs(new org.apache.hadoop.fs.Path(tezLibPath_";
  protected final String TEXT_513 = "));";
  protected final String TEXT_514 = NL + "                String[] classPaths_";
  protected final String TEXT_515 = " = System.getProperty(\"java.class.path\").split(";
  protected final String TEXT_516 = "String.valueOf(globalMap.get(\"current_client_path_separator\"))";
  protected final String TEXT_517 = "System.getProperty(\"path.separator\")";
  protected final String TEXT_518 = ");" + NL + "                String tezLibLocalPath_";
  protected final String TEXT_519 = " = null;" + NL + "                for(String classPath_";
  protected final String TEXT_520 = " : classPaths_";
  protected final String TEXT_521 = "){";
  protected final String TEXT_522 = NL + "                        if(classPath_";
  protected final String TEXT_523 = ".endsWith(\"";
  protected final String TEXT_524 = "\")){" + NL + "                            org.apache.hadoop.fs.Path tezJarPath_";
  protected final String TEXT_525 = " = new org.apache.hadoop.fs.Path(tezLibPath_";
  protected final String TEXT_526 = " + \"/";
  protected final String TEXT_527 = "\");" + NL + "                            if(!fs_";
  protected final String TEXT_528 = ".exists(tezJarPath_";
  protected final String TEXT_529 = ")){" + NL + "                                fs_";
  protected final String TEXT_530 = ".copyFromLocalFile(false, false, new org.apache.hadoop.fs.Path(classPath_";
  protected final String TEXT_531 = "), tezJarPath_";
  protected final String TEXT_532 = ");" + NL + "                            }" + NL + "                        }";
  protected final String TEXT_533 = NL + "                }";
  protected final String TEXT_534 = NL + "                String tezLibPath_";
  protected final String TEXT_535 = " = ";
  protected final String TEXT_536 = ";";
  protected final String TEXT_537 = NL + "\t\t\tStringBuilder script_";
  protected final String TEXT_538 = " = new StringBuilder();" + NL + "\t\t\tString[] tezLibPaths_";
  protected final String TEXT_539 = " = tezLibPath_";
  protected final String TEXT_540 = ".split(\",\");" + NL + "\t\t\tscript_";
  protected final String TEXT_541 = ".append(\"SET tez.lib.uris=\");" + NL + "\t\t\tint tezLibPathCount_";
  protected final String TEXT_542 = " = 1;" + NL + "\t\t\tfor(String tezLibPathKey_";
  protected final String TEXT_543 = " : tezLibPaths_";
  protected final String TEXT_544 = "){" + NL + "\t\t\t\t script_";
  protected final String TEXT_545 = ".append(";
  protected final String TEXT_546 = " + \"/\" + tezLibPathKey_";
  protected final String TEXT_547 = ");" + NL + "\t\t\t\t if(tezLibPathCount_";
  protected final String TEXT_548 = " < tezLibPaths_";
  protected final String TEXT_549 = ".length){" + NL + "\t\t\t\t \tscript_";
  protected final String TEXT_550 = ".append(\",\");" + NL + "\t\t\t\t }" + NL + "\t\t\t\t tezLibPathCount_";
  protected final String TEXT_551 = "++;" + NL + "\t\t\t}" + NL + "\t\t\tinit_";
  protected final String TEXT_552 = ".execute(script_";
  protected final String TEXT_553 = ".toString());" + NL + "\t\t";
  protected final String TEXT_554 = NL + "\t";
  protected final String TEXT_555 = NL + NL + "\tinit_";
  protected final String TEXT_556 = ".close();" + NL + "" + NL + "\t";
  protected final String TEXT_557 = NL + "\t\tjava.sql.Statement statement_";
  protected final String TEXT_558 = " = conn_";
  protected final String TEXT_559 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_560 = NL + "\t\t\tstatement_";
  protected final String TEXT_561 = ".execute(\"SET hbase.zookeeper.quorum=\"+";
  protected final String TEXT_562 = ");" + NL + "\t\t";
  protected final String TEXT_563 = NL + NL + "\t\t";
  protected final String TEXT_564 = NL + "\t\t\tstatement_";
  protected final String TEXT_565 = ".execute(\"SET hbase.zookeeper.property.clientPort=\"+";
  protected final String TEXT_566 = ");" + NL + "\t\t";
  protected final String TEXT_567 = NL + NL + "\t\t";
  protected final String TEXT_568 = NL + "\t\t\tstatement_";
  protected final String TEXT_569 = ".execute(\"SET zookeeper.znode.parent=\"+";
  protected final String TEXT_570 = ");" + NL + "\t\t";
  protected final String TEXT_571 = NL + NL + "\t\t";
  protected final String TEXT_572 = NL + "\t\t\tstatement_";
  protected final String TEXT_573 = ".execute(\"SET hbase.security.authentication=kerberos\");" + NL + "\t\t\tstatement_";
  protected final String TEXT_574 = ".execute(\"SET hbase.rpc.engine=org.apache.hadoop.hbase.ipc.SecureRpcEngine\");" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_575 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_576 = ".execute(\"SET hbase.master.kerberos.principal=\"+";
  protected final String TEXT_577 = ");" + NL + "\t\t\t";
  protected final String TEXT_578 = NL + "\t\t\t";
  protected final String TEXT_579 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_580 = ".execute(\"SET hbase.regionserver.kerberos.principal=\"+";
  ...
  protected final String TEXT_585 = ".execute(\"add jar \"+";
  protected final String TEXT_586 = ");" + NL + "\t\t";
  protected final String TEXT_587 = NL + "\t\tstatement_";
  protected final String TEXT_588 = ".close();" + NL + "\t";
  protected final String TEXT_589 = NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_590 = "\",conn_";
  protected final String TEXT_591 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_592 = "\",";
  protected final String TEXT_593 = ");" + NL + "" + NL + "\tString currentClientPathSeparator_";
  protected final String TEXT_594 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "\tif(currentClientPathSeparator_";
  protected final String TEXT_595 = "!=null) {" + NL + "\t\tSystem.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_596 = ");" + NL + "\t\tglobalMap.put(\"current_client_path_separator\", null);" + NL + "\t}" + NL + "" + NL + "\tString currentClientUsername_";
  protected final String TEXT_597 = " = (String)globalMap.get(\"current_client_user_name\");" + NL + "\tif(currentClientUsername_";
  protected final String TEXT_598 = "!=null) {" + NL + "\t\tSystem.setProperty(\"user.name\", currentClientUsername_";
  protected final String TEXT_599 = ");" + NL + "\t\tglobalMap.put(\"current_client_user_name\", null);" + NL + "\t}" + NL + "" + NL + "\tString originalHadoopUsername_";
  protected final String TEXT_600 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_601 = "\");" + NL + "\tif(originalHadoopUsername_";
  protected final String TEXT_602 = "!=null) {" + NL + "\t\tSystem.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_603 = ");" + NL + "\t\tglobalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_604 = "\", null);" + NL + "\t} else {" + NL + "\t\tSystem.clearProperty(\"HADOOP_USER_NAME\");" + NL + "\t}";
