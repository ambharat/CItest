...
public class TJDBCInputBeginJava
{
  ...
  protected final String TEXT_407 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_408 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_409 = ".getColumnTypeName(i_";
  protected final String TEXT_410 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_411 = ".add(rs_";
  protected final String TEXT_412 = ".getString(i_";
  protected final String TEXT_413 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_414 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_427 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_428 = ".";
  protected final String TEXT_429 = ", rs_";
  protected final String TEXT_430 = ", fixedColumnCount_";
  protected final String TEXT_431 = ",";
  protected final String TEXT_432 = ");";
  protected final String TEXT_433 = NL + "                                  Object geom = rs_";
  protected final String TEXT_434 = ".getObject(";
  protected final String TEXT_435 = "column_index_";
  protected final String TEXT_436 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_437 = ".";
  protected final String TEXT_438 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_445 = " - Retrieving the record \" + nb_line_";
