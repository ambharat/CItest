...
public class TTeradataRowBeginJava
{
  ...
  protected final String TEXT_131 = NL + "    \tclass BytesLimit65535_";
  protected final String TEXT_132 = "{" + NL + "    \t\tpublic void limitLog4jByte() throws Exception{" + NL + "    \t\t\t";
  protected final String TEXT_133 = NL + "            StringBuilder ";
  protected final String TEXT_134 = " = new StringBuilder();";
  protected final String TEXT_135 = NL + "            ";
  protected final String TEXT_136 = ".append(\"Parameters:\");";
  protected final String TEXT_137 = NL + "                    ";
  protected final String TEXT_138 = ".append(\"";
  protected final String TEXT_139 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_140 = ").substring(0, 4) + \"...\");     ";
  ...
  protected final String TEXT_147 = NL + "    \t\t}" + NL + "    \t}" + NL + "    \t" + NL + "        new BytesLimit65535_";
  protected final String TEXT_148 = "().limitLog4jByte();";
  protected final String TEXT_149 = NL + "            StringBuilder ";
  protected final String TEXT_150 = " = new StringBuilder();    ";
  ...
  protected final String TEXT_159 = ".append(\"<null>\");" + NL + "                    }else{";
  ...
  protected final String TEXT_167 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_168 = " = ";
  protected final String TEXT_169 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_170 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_171 = " == null || dbProperties_";
  protected final String TEXT_172 = ".trim().length() == 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_173 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_174 = ";" + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_175 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_176 = " + \"/\" + ";
  protected final String TEXT_177 = ";" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_178 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_179 = " = null;" + NL + "\tString query_";
  protected final String TEXT_180 = " = \"\";" + NL + "\tboolean whetherReject_";
  ...
  protected final String TEXT_184 = ".prepareStatement(";
