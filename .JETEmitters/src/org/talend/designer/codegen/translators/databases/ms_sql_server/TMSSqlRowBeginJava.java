...
public class TMSSqlRowBeginJava
{
  ...
  protected final String TEXT_127 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_128 = " ;" + NL + "\t\t\t";
  protected final String TEXT_129 = "\t\t    " + NL + "\t\t    String url_";
  protected final String TEXT_130 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_131 = " ;" + NL + "\t\t\t";
  protected final String TEXT_132 = NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_133 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_134 = " += \":\" + ";
  protected final String TEXT_135 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_136 = ")) {" + NL + "\t\t   \t";
  protected final String TEXT_137 = NL + "\t\t\t\turl_";
  protected final String TEXT_138 = " += \"//\" + ";
  protected final String TEXT_139 = "; " + NL + "\t\t\t";
  protected final String TEXT_140 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_141 = " += \";databaseName=\" + ";
  protected final String TEXT_142 = "; " + NL + "\t\t\t";
  protected final String TEXT_143 = NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_144 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_145 = ";" + NL + "\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\t\tString dbschema_";
  protected final String TEXT_147 = " = (String)globalMap.get(\"";
  protected final String TEXT_148 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_149 = NL + "\t\t\t\t\tString dbschema_";
  protected final String TEXT_150 = " = ";
  protected final String TEXT_151 = ";" + NL + "\t    \t\t";
  protected final String TEXT_152 = NL + "\t\t        String  tableName_";
  protected final String TEXT_153 = " = null;" + NL + "\t\t        if(dbschema_";
  ...
  protected final String TEXT_160 = " + \"]\";" + NL + "\t\t        }" + NL + "\t\t        stmt_";
  protected final String TEXT_161 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_162 = " +\" ON\");" + NL + "\t\t\t";
