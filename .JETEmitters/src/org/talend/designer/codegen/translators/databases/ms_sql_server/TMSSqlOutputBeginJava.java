...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_89 = NL + "\t\tif (null == conn_";
  protected final String TEXT_90 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_91 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\tconn_";
  protected final String TEXT_92 = " = dataSources_";
  protected final String TEXT_93 = ".get(";
  protected final String TEXT_94 = ").getConnection();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_95 = NL + "\t";
  protected final String TEXT_96 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_97 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  ...
  protected final String TEXT_106 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_107 = NL + "    String driverClass_";
  protected final String TEXT_108 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_109 = NL + "\t";
  protected final String TEXT_110 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_111 = ");" + NL + "    String port_";
  protected final String TEXT_112 = " = ";
  protected final String TEXT_113 = ";" + NL + "    String dbname_";
  protected final String TEXT_114 = " = ";
  protected final String TEXT_115 = " ;";
  protected final String TEXT_116 = NL + "    String url_";
  protected final String TEXT_117 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_118 = " ;";
  protected final String TEXT_119 = NL + "    String url_";
  protected final String TEXT_120 = " = \"jdbc:sqlserver://\" + ";
  ...
  protected final String TEXT_135 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_159 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_160 = " = ";
  protected final String TEXT_161 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_162 = " = 0;" + NL;
  protected final String TEXT_163 = NL + "   int batchSize_";
  protected final String TEXT_164 = " = ";
  protected final String TEXT_165 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_212 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_220 = ".toUpperCase()";
  ...
  protected final String TEXT_372 = ".getTables(null, conn_";
  protected final String TEXT_373 = ".getSchema(), tableForSearch_";
  protected final String TEXT_374 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_375 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_376 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_377 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_384 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_385 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_386 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_387 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_388 = ")) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_399 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_400 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_426 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_437 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_445 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_459 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_476 = NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_480 = " = 0;" + NL + "            if(rsTruncCount_";
  ...
  protected final String TEXT_485 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_502 = ".close();";
  protected final String TEXT_503 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_504 = " = conn_";
  protected final String TEXT_505 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_506 = " = stmtTruncCount_";
  protected final String TEXT_507 = ".executeQuery(\"";
  protected final String TEXT_508 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_512 = ".commit();";
  protected final String TEXT_513 = NL + "            stmtTrunc_";
  protected final String TEXT_514 = ".executeUpdate(\"";
  protected final String TEXT_515 = "\");";
  protected final String TEXT_516 = NL + "            while(rsTruncCount_";
  protected final String TEXT_517 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_518 = " += rsTruncCount_";
  protected final String TEXT_519 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_520 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_521 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_534 = " = null;" + NL + "\t\tString keyPsmt_";
  ...
  protected final String TEXT_552 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_584 = NL + "        String delete_";
  protected final String TEXT_585 = " = \"DELETE FROM [\" + tableName_";
  ...
  protected final String TEXT_589 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_603 = NL + NL + "    class BufferLine_";
  ...
  protected final String TEXT_618 = "> sInsertColValueList";
  protected final String TEXT_619 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_620 = " sInsertColValue";
  protected final String TEXT_621 = " = null;" + NL + "" + NL + "    StringBuilder extendInsertValueStmt_";
  ...
  protected final String TEXT_627 = ".append(\",\");" + NL + "    }" + NL + "" + NL + "\tString insert_";
  protected final String TEXT_628 = " = \"INSERT INTO \"+";
  protected final String TEXT_629 = "+\" (";
  protected final String TEXT_630 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_631 = ".toString();" + NL + "" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_632 = " =  conn_";
  protected final String TEXT_633 = ".prepareStatement(insert_";
  protected final String TEXT_634 = ");" + NL + "" + NL + "    String insertColName";
  protected final String TEXT_635 = " = \"";
  protected final String TEXT_636 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_637 = " =  \"";
  protected final String TEXT_638 = "\";" + NL + "    int rowCount";
  protected final String TEXT_639 = " = 0;";
  ...
  protected final String TEXT_670 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_671 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_672 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_673 = "\") == true;";
  protected final String TEXT_674 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_675 = " = conn_";
  protected final String TEXT_676 = ".createStatement();";
  protected final String TEXT_677 = NL + "\t        if ( !isShareIdentity_";
