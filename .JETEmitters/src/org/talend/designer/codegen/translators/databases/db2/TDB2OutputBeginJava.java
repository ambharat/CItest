...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_81 = ").getConnection();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_82 = NL + "    dbUser_";
  ...
  protected final String TEXT_97 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_98 = " + \":\" + ";
  protected final String TEXT_99 = " + \"/\" + ";
  protected final String TEXT_100 = " + \":\" + ";
  protected final String TEXT_101 = ";";
  protected final String TEXT_102 = NL + "    java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");" + NL + "\t";
  protected final String TEXT_103 = NL + "    dbUser_";
  ...
  protected final String TEXT_115 = ";" + NL + "" + NL + "    dbschema_";
  ...
  protected final String TEXT_148 = NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_159 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_163 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_164 = "));";
  protected final String TEXT_165 = NL + "                    stmtCreate_";
  protected final String TEXT_166 = ".execute(((\"";
  protected final String TEXT_167 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_228 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_229 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_230 = " = tableNameForSearch_";
  protected final String TEXT_231 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_232 = " = tableNameForSearch_";
  protected final String TEXT_233 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_237 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_238 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_239 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_240 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_285 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_286 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_295 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_296 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_297 = " == null || dbschema_";
  protected final String TEXT_298 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_305 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_306 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_307 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_322 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_323 = ".equals";
  protected final String TEXT_324 = "IgnoreCase";
  protected final String TEXT_325 = "(schema_";
  ...
  protected final String TEXT_329 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_330 = " = ";
  protected final String TEXT_331 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_332 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_333 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_334 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_335 = " =  tableForSearch_";
  protected final String TEXT_336 = ".substring(1,tableForSearch_";
  protected final String TEXT_337 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_338 = " =  tableForSearch_";
  protected final String TEXT_339 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_343 = ".getTables(null, conn_";
  protected final String TEXT_344 = ".getSchema(), tableForSearch_";
  protected final String TEXT_345 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_346 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_347 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_348 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_397 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_408 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_582 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_583 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_592 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_602 = NL + "class SetPrepareStatementUtil_";
  protected final String TEXT_603 = " {";
  protected final String TEXT_604 = NL + "\t\t\tvoid set";
  protected final String TEXT_605 = "_";
  protected final String TEXT_606 = "(" + NL + "\t\t\t\tfinal ";
  protected final String TEXT_607 = "Struct ";
  protected final String TEXT_608 = "," + NL + "\t\t\t\tfinal java.sql.PreparedStatement";
  ...
  protected final String TEXT_612 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal StringBuffer query_";
  protected final String TEXT_613 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal String[] ";
  protected final String TEXT_614 = NL + "\t\t\t) throws java.sql.SQLException {" + NL + "\t\t\t//}";
  ...
  protected final String TEXT_620 = NL + "}" + NL + "" + NL + "SetPrepareStatementUtil_";
  protected final String TEXT_621 = " setPrepareStatementUtil_";
  protected final String TEXT_622 = " = new SetPrepareStatementUtil_";
  protected final String TEXT_623 = "();" + NL;
  protected final String TEXT_624 = NL + NL + "class DataPropagateUtil_";
  protected final String TEXT_625 = " {";
  protected final String TEXT_626 = NL + "\t\t\tvoid assign_";
  ...
  protected final String TEXT_640 = NL + "}" + NL + "" + NL + "DataPropagateUtil_";
  protected final String TEXT_641 = " dataPropagateUtil_";
  protected final String TEXT_642 = " = new DataPropagateUtil_";
  protected final String TEXT_643 = "();" + NL + NL + NL;
