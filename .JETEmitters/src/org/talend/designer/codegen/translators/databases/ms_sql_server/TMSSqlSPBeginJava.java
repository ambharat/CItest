...
public class TMSSqlSPBeginJava
{
  ...
  protected final String TEXT_60 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\tconn_";
  protected final String TEXT_61 = " = dataSources_";
  protected final String TEXT_62 = ".get(";
  protected final String TEXT_63 = ").getConnection();" + NL + "\t\t}" + NL + "\t";
  ...
  protected final String TEXT_70 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_71 = NL + "    dbschema_";
  protected final String TEXT_72 = " = ";
  protected final String TEXT_73 = ";";
  protected final String TEXT_74 = NL + "    String driverClass_";
  protected final String TEXT_75 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_76 = NL + "    String driverClass_";
  protected final String TEXT_77 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_78 = NL + "\t";
  protected final String TEXT_79 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_80 = ");" + NL + "    String port_";
  protected final String TEXT_81 = " = ";
  protected final String TEXT_82 = ";" + NL + "    String dbname_";
  protected final String TEXT_83 = " = ";
  protected final String TEXT_84 = " ;";
  protected final String TEXT_85 = NL + "    String url_";
  protected final String TEXT_86 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_87 = " ;";
  protected final String TEXT_88 = NL + "    String url_";
  protected final String TEXT_89 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_90 = " ;";
  protected final String TEXT_91 = " " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_92 = ")) {" + NL + "    \turl_";
  protected final String TEXT_93 = " += \":\" + ";
  protected final String TEXT_94 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_95 = ")) {";
  protected final String TEXT_96 = NL + "\t\t\t\turl_";
  protected final String TEXT_97 = " += \"//\" + ";
  protected final String TEXT_98 = "; " + NL + "\t";
  protected final String TEXT_99 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_100 = " += \";databaseName=\" + ";
  protected final String TEXT_101 = "; " + NL + "\t";
  protected final String TEXT_102 = NL + "    }" + NL + "    url_";
  protected final String TEXT_103 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_104 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_124 = NL + "//java.sql.Statement stmt_";
  protected final String TEXT_125 = " = conn_";
  protected final String TEXT_126 = ".createStatement();" + NL + "" + NL + "//stmt_";
  protected final String TEXT_127 = ".execute(\"SET NOCOUNT ON\");" + NL + "" + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_128 = " = conn_";
  protected final String TEXT_129 = ".prepareCall(\"{";
  protected final String TEXT_130 = "call \" + ";
  protected final String TEXT_131 = " + \"(";
  protected final String TEXT_132 = ")}\"";
  protected final String TEXT_133 = NL + "\t,java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE, java.sql.ResultSet.CONCUR_READ_ONLY";
  protected final String TEXT_134 = NL + ");" + NL + "" + NL + "java.sql.Timestamp tmpDate_";
  protected final String TEXT_135 = ";" + NL + "String tmpString_";
