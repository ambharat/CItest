...
public class TNetezzaInputBeginJava
{
  ...
  protected final String TEXT_380 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_381 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_382 = ".getColumnTypeName(i_";
  protected final String TEXT_383 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_384 = ".add(rs_";
  protected final String TEXT_385 = ".getString(i_";
  protected final String TEXT_386 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_387 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_388 = ".";
  protected final String TEXT_389 = ", rs_";
  protected final String TEXT_390 = ", fixedColumnCount_";
  protected final String TEXT_391 = ",list_";
  ...
  protected final String TEXT_406 = NL + "                                  Object geom = rs_";
  protected final String TEXT_407 = ".getObject(";
  protected final String TEXT_408 = "column_index_";
  protected final String TEXT_409 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_410 = ".";
  protected final String TEXT_411 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_412 = ".";
  protected final String TEXT_413 = " = null;" + NL + "                                  }";
  protected final String TEXT_414 = NL + "\t\t                          ";
  protected final String TEXT_415 = NL + "\t\t                    }";
  protected final String TEXT_416 = NL + "\t\t\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_418 = " - Retrieving the record \" + nb_line_";
