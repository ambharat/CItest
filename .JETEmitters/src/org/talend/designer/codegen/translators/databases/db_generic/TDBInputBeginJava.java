...
public class TDBInputBeginJava
{
  ...
  protected final String TEXT_463 = NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_464 = ".getColumnTypeName(i_";
  protected final String TEXT_465 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_466 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_467 = ".getClob(i_";
  protected final String TEXT_468 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_469 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_470 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_471 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_472 = ".add(tNTextImpl_";
  protected final String TEXT_473 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_474 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_475 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_476 = ".getColumnTypeName(i_";
  protected final String TEXT_477 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_478 = ".add(rs_";
  protected final String TEXT_479 = ".getString(i_";
  protected final String TEXT_480 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_481 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_482 = ".";
  protected final String TEXT_483 = ", rs_";
  protected final String TEXT_484 = ", fixedColumnCount_";
  protected final String TEXT_485 = ",list_";
  protected final String TEXT_486 = ",";
  protected final String TEXT_487 = ");";
  protected final String TEXT_488 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_489 = ".";
  protected final String TEXT_490 = ", rs_";
  protected final String TEXT_491 = ", fixedColumnCount_";
  protected final String TEXT_492 = ",";
  protected final String TEXT_493 = ");";
  protected final String TEXT_494 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_495 = ".";
  protected final String TEXT_496 = ", rs_";
  protected final String TEXT_497 = ", fixedColumnCount_";
  protected final String TEXT_498 = ",";
  protected final String TEXT_499 = ");";
  protected final String TEXT_500 = NL + "                                  Object geom = rs_";
  protected final String TEXT_501 = ".getObject(";
  protected final String TEXT_502 = "column_index_";
  protected final String TEXT_503 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_504 = ".";
  protected final String TEXT_505 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_511 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_512 = " - Retrieving the record \" + nb_line_";
