...
public class TJDBCOutputBeginJava {
  ...
  protected final String TEXT_70 = NL + "\t\tif (null == connection_";
  protected final String TEXT_71 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_72 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\tconnection_";
  protected final String TEXT_73 = " = dataSources_";
  protected final String TEXT_74 = ".get(";
  protected final String TEXT_75 = ").getConnection();" + NL + "\t\t\tif (connection_";
  protected final String TEXT_76 = " != null) {" + NL + "\t\t\t\tconnection_";
  protected final String TEXT_77 = ".setAutoCommit(";
  protected final String TEXT_78 = ");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_79 = NL + NL + "\tjava.sql.Connection connection_";
  ...
  protected final String TEXT_89 = ");" + NL + "\t\t\tString connectionString_";
  ...
  protected final String TEXT_120 = NL + "\tjava.sql.Statement statementClear_";
  ...
  protected final String TEXT_124 = " + statementClear_";
  protected final String TEXT_125 = ".executeUpdate(\"delete from \" + ";
