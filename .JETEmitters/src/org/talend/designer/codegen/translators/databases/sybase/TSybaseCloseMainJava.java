...
public class TSybaseCloseMainJava
{
  ...
  protected final String TEXT_52 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES); " + NL + "\t\t\tif(dataSources_";
  protected final String TEXT_53 = "!=null) {" + NL + "\t\t\t\tif(dataSources_";
  protected final String TEXT_54 = ".get(";
  protected final String TEXT_55 = ")!=null) {" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_56 = " = dataSources_";
  protected final String TEXT_57 = ".get(";
  protected final String TEXT_58 = ").getConnection();" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_59 = NL + "\tif(conn_";
  protected final String TEXT_60 = " != null && !conn_";
  protected final String TEXT_61 = ".isClosed())" + NL + "\t{";
