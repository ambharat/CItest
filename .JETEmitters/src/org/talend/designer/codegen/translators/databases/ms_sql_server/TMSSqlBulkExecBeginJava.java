...
public class TMSSqlBulkExecBeginJava {
  ...
  protected final String TEXT_179 = NL + "\t\tif (null == conn_";
  protected final String TEXT_180 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_181 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\tconn_";
  protected final String TEXT_182 = " = dataSources_";
  protected final String TEXT_183 = ".get(";
  protected final String TEXT_184 = ").getConnection();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_185 = NL + "\t";
  protected final String TEXT_186 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_187 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_188 = ") {" + NL + "\t\t\tconn_";
  protected final String TEXT_189 = " = dataSources_";
  protected final String TEXT_190 = ".get(";
  protected final String TEXT_191 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_192 = NL + "    dbschema_";
  protected final String TEXT_193 = " = ";
  protected final String TEXT_194 = ";";
  protected final String TEXT_195 = NL + "    String driverClass_";
  protected final String TEXT_196 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_197 = NL + "    String driverClass_";
  protected final String TEXT_198 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_199 = NL + "\t";
  protected final String TEXT_200 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_201 = ");" + NL + "    String port_";
  protected final String TEXT_202 = " = ";
  protected final String TEXT_203 = ";" + NL + "    String dbname_";
  protected final String TEXT_204 = " = ";
  protected final String TEXT_205 = " ;";
  protected final String TEXT_206 = NL + "    String url_";
  protected final String TEXT_207 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_208 = " ;";
  protected final String TEXT_209 = NL + "    String url_";
  protected final String TEXT_210 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_211 = " ;";
  protected final String TEXT_212 = " " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_213 = ")) {" + NL + "    \turl_";
  protected final String TEXT_214 = " += \":\" + ";
  protected final String TEXT_215 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_216 = ")) {";
  protected final String TEXT_217 = NL + "\t\t\t\turl_";
  protected final String TEXT_218 = " += \"//\" + ";
  protected final String TEXT_219 = "; " + NL + "\t";
  protected final String TEXT_220 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_221 = " += \";databaseName=\" + ";
  protected final String TEXT_222 = "; " + NL + "\t";
  protected final String TEXT_223 = NL + "    }" + NL + "    url_";
  protected final String TEXT_224 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_225 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_235 = NL + NL + "    String dbPwd_";
  ...
  protected final String TEXT_240 = ",dbUser_";
  protected final String TEXT_241 = ",dbPwd_";
  protected final String TEXT_242 = ");";
  protected final String TEXT_243 = NL + "\t";
  protected final String TEXT_244 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_245 = NL + "\tString tableName_";
  protected final String TEXT_246 = " = null;\t" + NL + "\tif(dbschema_";
  protected final String TEXT_247 = " == null || dbschema_";
  protected final String TEXT_248 = ".trim().length() == 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_249 = " = ";
  protected final String TEXT_250 = ";" + NL + "\t} else {" + NL + "\t\ttableName_";
  protected final String TEXT_251 = " = dbschema_";
  protected final String TEXT_252 = " + \"].[\" + ";
  protected final String TEXT_253 = ";" + NL + "\t}" + NL + "\t";
  protected final String TEXT_254 = "\t" + NL + "\t\t";
  protected final String TEXT_255 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_259 = " - Droping table ";
  ...
  protected final String TEXT_267 = " - Drop table ";
  protected final String TEXT_268 = "\" + tableName_";
  protected final String TEXT_269 = " + \"";
  protected final String TEXT_270 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_271 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_272 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_294 = " - Creating table ";
  ...
  protected final String TEXT_302 = " - Create table ";
  protected final String TEXT_303 = "\" + tableName_";
  ...
  protected final String TEXT_311 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_312 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_313 = " = tableNameForSearch_";
  protected final String TEXT_314 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_315 = " = tableNameForSearch_";
  protected final String TEXT_316 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_317 = " = dbMetaData_";
  protected final String TEXT_318 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_319 = ", tableNameForSearch_";
  protected final String TEXT_320 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_321 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_322 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_323 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_338 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_339 = ") || dbschema_";
  protected final String TEXT_340 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_351 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_355 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_356 = ".equals(schema_";
  protected final String TEXT_357 = ") || (schema_";
  protected final String TEXT_358 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_359 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_402 = NL + "            \tString tableForSearch_";
  protected final String TEXT_403 = " = ";
  protected final String TEXT_404 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_405 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_406 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_407 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_408 = " =  tableForSearch_";
  protected final String TEXT_409 = ".substring(1,tableForSearch_";
  protected final String TEXT_410 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_411 = " =  tableForSearch_";
  protected final String TEXT_412 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_413 = " = conn_";
  protected final String TEXT_414 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_415 = " = dbMetaData_";
  protected final String TEXT_416 = ".getTables(null, conn_";
  protected final String TEXT_417 = ".getSchema(), tableForSearch_";
  protected final String TEXT_418 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_419 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_420 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_421 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  ...
  protected final String TEXT_425 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_426 = " = dbMetaData_";
  protected final String TEXT_427 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_428 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_439 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_443 = " - Creating table ";
  ...
  protected final String TEXT_451 = " - Create table ";
  ...
  protected final String TEXT_456 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_457 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_458 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_462 = " - Droping table ";
  ...
  protected final String TEXT_470 = " - Drop table ";
  protected final String TEXT_471 = "\" + tableName_";
  protected final String TEXT_472 = " + \"";
  protected final String TEXT_473 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_493 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_497 = " - Clearing table ";
  protected final String TEXT_498 = "\" + tableName_";
  protected final String TEXT_499 = " + \"";
  protected final String TEXT_500 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_501 = NL + "\t\t\tstmtClear_";
  ...
  protected final String TEXT_505 = "- Clear table ";
  protected final String TEXT_506 = "\" + tableName_";
  protected final String TEXT_507 = " + \"";
  protected final String TEXT_508 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_509 = NL + "\t\t\tstmtClear_";
  ...
  protected final String TEXT_520 = " - Trancating table ";
  ...
  protected final String TEXT_528 = " - Truncate table ";
  protected final String TEXT_529 = "\" + tableName_";
  protected final String TEXT_530 = " + \"";
  protected final String TEXT_531 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_532 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_533 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_534 = " += rsTruncCount_";
  protected final String TEXT_535 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_536 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_537 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_538 = ".close();" + NL + "\t\t";
  protected final String TEXT_539 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_540 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_541 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_542 = NL + "    \t";
  protected final String TEXT_543 = NL + "    \t\tjava.sql.Statement stmtBulkInsert_";
  protected final String TEXT_544 = " = conn_";
  protected final String TEXT_545 = ".createStatement();" + NL + "    \t\tString bulkSQL_";
  protected final String TEXT_546 = " = \"BULK INSERT ";
  protected final String TEXT_547 = "\" + tableName_";
  protected final String TEXT_548 = " + \"";
  protected final String TEXT_549 = " FROM '\" + ";
  protected final String TEXT_550 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_551 = " + \"',DATAFILETYPE='";
  protected final String TEXT_552 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_553 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_554 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_555 = "+\"')\";" + NL + "    \t\t";
  protected final String TEXT_556 = NL + "    \t\t\tlog.debug(\"";
  protected final String TEXT_557 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_558 = "+\".\");" + NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_559 = " - Bulk inserting data into ";
  ...
  protected final String TEXT_564 = ".execute(bulkSQL_";
  protected final String TEXT_565 = ");" + NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_566 = ".close();" + NL + "    \t\t";
  protected final String TEXT_567 = NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_568 = " - Bulk insert data into ";
  protected final String TEXT_569 = "\" + tableName_";
  protected final String TEXT_570 = " + \"";
  protected final String TEXT_571 = " has finished.\");" + NL + "    \t\t";
  protected final String TEXT_572 = NL + "    \t\t\tint keyCount_";
  protected final String TEXT_573 = " = ";
  protected final String TEXT_574 = ";" + NL + "    \t\t\tif(keyCount_";
  protected final String TEXT_575 = " == 0) {" + NL + "    \t\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "    \t\t\t}" + NL + "    \t\t\tString tmpTableName_";
  protected final String TEXT_576 = " = tableName_";
  protected final String TEXT_577 = ";" + NL + "    \t\t\ttableName_";
  protected final String TEXT_578 = " = \"tmp_";
  protected final String TEXT_579 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtCreateTmp_";
  protected final String TEXT_580 = " = conn_";
  protected final String TEXT_581 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_582 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_583 = " - Creating temp table ";
  protected final String TEXT_584 = "\" + tableName_";
  protected final String TEXT_585 = " + \"";
  protected final String TEXT_586 = ".\" );" + NL + "    \t\t\t";
  protected final String TEXT_587 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_588 = ".execute(\"";
  protected final String TEXT_589 = ")\");" + NL + "    \t\t\t";
  protected final String TEXT_590 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_591 = " - Create temp table ";
  protected final String TEXT_592 = "\" + tableName_";
  protected final String TEXT_593 = " + \"";
  protected final String TEXT_594 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_595 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_596 = ".close();" + NL + "    \t\t\tjava.sql.Statement stmtTmpBulk_";
  protected final String TEXT_597 = " = conn_";
  protected final String TEXT_598 = ".createStatement();" + NL + "    \t\t\tString bulkSQL_";
  protected final String TEXT_599 = " = \"BULK INSERT ";
  protected final String TEXT_600 = "\" + tableName_";
  protected final String TEXT_601 = " + \"";
  protected final String TEXT_602 = " FROM '\" + ";
  protected final String TEXT_603 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_604 = " + \"',DATAFILETYPE='";
  protected final String TEXT_605 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_606 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_607 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_608 = "+\"')\";" + NL + "    \t\t\t";
  protected final String TEXT_609 = NL + "    \t\t\t\tlog.debug(\"";
  protected final String TEXT_610 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_611 = "+\".\");" + NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_612 = " - Bulk inserting data into ";
  ...
  protected final String TEXT_617 = ".execute(bulkSQL_";
  protected final String TEXT_618 = ");" + NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_619 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_620 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_621 = " - Bulk insert data into ";
  protected final String TEXT_622 = "\" + tableName_";
  protected final String TEXT_623 = " + \"";
  protected final String TEXT_624 = " has finished.\");" + NL + "    \t\t\t";
  protected final String TEXT_625 = NL + "    \t\t\ttableName_";
  protected final String TEXT_626 = " = tmpTableName_";
  protected final String TEXT_627 = ";" + NL + "    \t\t\ttmpTableName_";
  protected final String TEXT_628 = " = \"tmp_";
  protected final String TEXT_629 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_630 = " = conn_";
  protected final String TEXT_631 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_632 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_633 = " - Updating ";
  protected final String TEXT_634 = "\" + tableName_";
  protected final String TEXT_635 = " + \"";
  protected final String TEXT_636 = " from ";
  protected final String TEXT_637 = "\"+tmpTableName_";
  protected final String TEXT_638 = "+\"";
  protected final String TEXT_639 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_640 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_641 = ".executeUpdate(\"";
  protected final String TEXT_642 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_643 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_644 = ".close();" + NL + "    \t\t\ttableName_";
  protected final String TEXT_645 = " = \"tmp_";
  protected final String TEXT_646 = "\" + \"_\" +pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtTmpDrop_";
  protected final String TEXT_647 = " = conn_";
  protected final String TEXT_648 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_649 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_650 = " - Droping temp table ";
  protected final String TEXT_651 = "\" + tableName_";
  protected final String TEXT_652 = " + \"";
  protected final String TEXT_653 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_654 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_655 = ".execute(\"";
  protected final String TEXT_656 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_657 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_658 = " - Drop temp table ";
  protected final String TEXT_659 = "\" + tableName_";
  protected final String TEXT_660 = "+ \"";
  protected final String TEXT_661 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_662 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_663 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_664 = NL + "\t\tif(conn_";
  protected final String TEXT_665 = " != null && !conn_";
  protected final String TEXT_666 = ".isClosed()) {" + NL + "\t\t   ";
