...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_97 = NL + "\t\tjava.sql.Savepoint  sp_";
  protected final String TEXT_98 = " = null;" + NL + "\t";
  protected final String TEXT_99 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_100 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_101 = ") {" + NL + "\t\t\tconn_";
  protected final String TEXT_102 = " = dataSources_";
  protected final String TEXT_103 = ".get(";
  protected final String TEXT_104 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_105 = NL + "\t";
  protected final String TEXT_106 = NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");" + NL + "    String url_";
  protected final String TEXT_107 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_108 = "+\":\"+";
  protected final String TEXT_109 = "+\"/\"+";
  protected final String TEXT_110 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_125 = ",dbUser_";
  protected final String TEXT_126 = ",dbPwd_";
  ...
  protected final String TEXT_133 = NL + "    \tjava.sql.Savepoint  sp_";
  protected final String TEXT_134 = " = null;" + NL + "\t";
  protected final String TEXT_135 = NL + "        conn_";
  protected final String TEXT_136 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_137 = " = ";
  protected final String TEXT_138 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_139 = " = 0;";
  protected final String TEXT_140 = NL;
  protected final String TEXT_141 = NL + "    if(conn_";
  protected final String TEXT_142 = ".getAutoCommit()){" + NL + "    \tthrow new RuntimeException(\"Connection autocommit must be off to use savePoint\");" + NL + "    }";
  ...
  protected final String TEXT_584 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_585 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_586 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_587 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_588 = " = true;" + NL + "    \t";
  protected final String TEXT_589 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_590 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_591 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_600 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_601 = " = null;";
  protected final String TEXT_602 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_603 = " = null;";
  protected final String TEXT_604 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_605 = " = null;";
  protected final String TEXT_606 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
