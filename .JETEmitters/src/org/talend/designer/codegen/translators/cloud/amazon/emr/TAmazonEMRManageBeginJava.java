...
public class TAmazonEMRManageBeginJava
{
  ...
  protected final String TEXT_57 = NL + "\tcom.amazonaws.auth.STSAssumeRoleSessionCredentialsProvider.Builder credentialsProviderBuilder_";
  protected final String TEXT_58 = " = new com.amazonaws.auth.STSAssumeRoleSessionCredentialsProvider" + NL + "\t\t\t\t\t\t.Builder(";
  protected final String TEXT_59 = ", ";
  protected final String TEXT_60 = ")";
  protected final String TEXT_61 = ".withServiceEndpoint(";
  protected final String TEXT_62 = ")";
  protected final String TEXT_63 = NL + "\t\t\t\t\t\t.withLongLivedCredentialsProvider(credentialsProvider_";
  protected final String TEXT_64 = ")" + NL + "\t\t\t\t\t\t.withRoleSessionDurationSeconds(";
  protected final String TEXT_65 = ");" + NL + "\t" + NL + "\tcredentialsProvider_";
  protected final String TEXT_66 = " = credentialsProviderBuilder_";
  protected final String TEXT_67 = ".build();" + NL + "\t";
  protected final String TEXT_68 = NL + "\t" + NL + "\tcom.amazonaws.services.elasticmapreduce.AmazonElasticMapReduceClient emr_";
  protected final String TEXT_69 = " = new com.amazonaws.services.elasticmapreduce.AmazonElasticMapReduceClient(credentialsProvider_";
  ...
  protected final String TEXT_75 = NL + "\t\tcom.amazonaws.services.elasticmapreduce.model.ListClustersRequest request_";
  protected final String TEXT_76 = " = new com.amazonaws.services.elasticmapreduce.model.ListClustersRequest()" + NL + "\t\t\t.withClusterStates(" + NL + "\t\t\t\tcom.amazonaws.services.elasticmapreduce.model.ClusterState.BOOTSTRAPPING," + NL + "\t\t\t\tcom.amazonaws.services.elasticmapreduce.model.ClusterState.STARTING," + NL + "\t\t\t\tcom.amazonaws.services.elasticmapreduce.model.ClusterState.RUNNING," + NL + "\t\t\t\tcom.amazonaws.services.elasticmapreduce.model.ClusterState.WAITING" + NL + "\t\t\t)" + NL + "\t\t;" + NL + "    \tcom.amazonaws.services.elasticmapreduce.model.ListClustersResult result_";
  protected final String TEXT_77 = " = emr_";
  protected final String TEXT_78 = ".listClusters(request_";
  protected final String TEXT_79 = ");" + NL + "    \tjava.util.List<com.amazonaws.services.elasticmapreduce.model.ClusterSummary> clusters_";
  protected final String TEXT_80 = " = result_";
  protected final String TEXT_81 = ".getClusters();" + NL + "    \t" + NL + "    \tjava.util.List<String> ids_";
  protected final String TEXT_82 = " = new java.util.ArrayList<String>();" + NL + "    \t" + NL + "    \t";
  protected final String TEXT_83 = NL + "    \tfor(com.amazonaws.services.elasticmapreduce.model.ClusterSummary summary_";
  protected final String TEXT_84 = " : clusters_";
  protected final String TEXT_85 = ") {" + NL + "\t\t\t";
  protected final String TEXT_86 = NL + "\t\t\t\tids_";
  protected final String TEXT_87 = ".add(summary_";
  protected final String TEXT_88 = ".getId());" + NL + "\t\t\t";
  protected final String TEXT_89 = NL + "\t\t\t\tif(";
  protected final String TEXT_90 = ".equals(summary_";
  protected final String TEXT_91 = ".getName())) {" + NL + "\t\t\t\t\tids_";
  protected final String TEXT_92 = ".add(summary_";
  protected final String TEXT_93 = ".getId());" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_94 = NL + "\t\t\t\tif(";
  protected final String TEXT_95 = ".equals(summary_";
  protected final String TEXT_96 = ".getId())) {" + NL + "\t\t\t\t\tids_";
  protected final String TEXT_97 = ".add(summary_";
  protected final String TEXT_98 = ".getId());" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_99 = NL + "    \t}" + NL + "    \t" + NL + "    \tcom.amazonaws.services.elasticmapreduce.model.TerminateJobFlowsRequest request2_";
  protected final String TEXT_100 = " = new com.amazonaws.services.elasticmapreduce.model.TerminateJobFlowsRequest();" + NL + "    \tif(!ids_";
  protected final String TEXT_101 = ".isEmpty()) {" + NL + "    \t\trequest2_";
  protected final String TEXT_102 = ".withJobFlowIds(ids_";
  protected final String TEXT_103 = ");" + NL + "    \t\temr_";
  protected final String TEXT_104 = ".terminateJobFlows(request2_";
  protected final String TEXT_105 = ");\t" + NL + "    \t} else {" + NL + "    \t\t";
  protected final String TEXT_106 = NL + "    \t\t\tthrow new RuntimeException(\"can't find any running cluster\");" + NL + "    \t\t";
  protected final String TEXT_107 = NL + "    \t\t\tthrow new RuntimeException(\"can't find any running cluster with name : \" + ";
  protected final String TEXT_108 = ");" + NL + "    \t\t";
  protected final String TEXT_109 = NL + "    \t\t\tthrow new RuntimeException(\"can't find any running cluster with id : \" + ";
  protected final String TEXT_110 = ");" + NL + "    \t\t";
  protected final String TEXT_111 = NL + "    \t}" + NL + "    \t" + NL + "\t";
  protected final String TEXT_112 = NL + "\tcom.amazonaws.services.elasticmapreduce.util.StepFactory stepFactory_";
  protected final String TEXT_113 = " = new com.amazonaws.services.elasticmapreduce.util.StepFactory();" + NL + "" + NL + "\tcom.amazonaws.services.elasticmapreduce.model.StepConfig enabledebugging_";
  protected final String TEXT_114 = " = new com.amazonaws.services.elasticmapreduce.model.StepConfig()" + NL + "    \t.withName(\"Enable debugging\")" + NL + "    \t.withActionOnFailure(" + NL + "    \t\tcom.amazonaws.services.elasticmapreduce.model.ActionOnFailure.TERMINATE_JOB_FLOW" + NL + "    \t)" + NL + "    \t.withHadoopJarStep(stepFactory_";
  protected final String TEXT_115 = ".newEnableDebuggingStep());" + NL + "" + NL + "\tsteps_";
  protected final String TEXT_116 = ".add(0, enabledebugging_";
  protected final String TEXT_117 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_118 = NL + "\t";
  protected final String TEXT_119 = "\tString[] applications_";
  protected final String TEXT_120 = " = " + NL + "\t";
  protected final String TEXT_121 = NL + "\t\t{}" + NL + "\t\t";
  protected final String TEXT_122 = NL + "\t\t{\"Ganglia\",\"Hadoop\",\"Hive\",\"Hue\",\"Mahout\",\"Pig\",\"Spark\"}" + NL + "\t\t";
  protected final String TEXT_123 = NL + "\t\t{\"Ganglia\",\"Hadoop\",\"Hive\",\"Hue\",\"Mahout\",\"Pig\",\"Spark\"}" + NL + "\t\t";
  protected final String TEXT_124 = NL + "\t\t{\"Hadoop\",\"Hive\",\"Hue\",\"Mahout\",\"Pig\",\"Spark\"}" + NL + "\t\t";
  protected final String TEXT_125 = NL + "\t\t{\"Hadoop\",\"Hive\",\"Mahout\",\"Pig\",\"Spark\"}" + NL + "\t\t";
  protected final String TEXT_126 = NL + "\t\t{\"Ganglia\",\"Hadoop\",\"Hive\",\"Hue\",\"Mahout\",\"Pig\"}" + NL + "\t\t";
  protected final String TEXT_127 = NL + "\t\t{\"Ganglia\",\"Hadoop\",\"Hive\",\"Pig\"}" + NL + "\t\t";
  protected final String TEXT_128 = NL + "\t\t{\"Ganglia\",\"Hadoop\",\"Hive\",\"Pig\"}" + NL + "\t\t";
  protected final String TEXT_129 = NL + "\t\t{\"Hadoop\",\"Hive\",\"Pig\"}" + NL + "\t\t";
  protected final String TEXT_130 = NL + "\t\t{\"Hadoop\",\"Hive\",\"Pig\"}" + NL + "\t\t";
  protected final String TEXT_131 = NL + "\t\t{\"Hadoop\",\"Hive\",\"Presto-Sandbox\"}" + NL + "\t\t";
  protected final String TEXT_132 = NL + "\t\t{\"Hadoop\",\"Hive\",\"Presto-Sandbox\"}" + NL + "\t\t";
  ...
  protected final String TEXT_135 = NL + "\t\t{\"Ganglia\",\"Hadoop\",\"Spark\"}" + NL + "\t\t";
  protected final String TEXT_136 = NL + "\t\t{\"Ganglia\",\"Hadoop\",\"Spark\"}" + NL + "\t\t";
  protected final String TEXT_137 = NL + "\t\t{\"Ganglia\",\"Hadoop\",\"Spark\"}" + NL + "\t\t";
  protected final String TEXT_138 = NL + "\t\t{\"Hadoop\",\"Spark\"}" + NL + "\t\t";
  protected final String TEXT_139 = NL + "\t\t{\"Hadoop\",\"Spark\"}" + NL + "\t\t";
  protected final String TEXT_140 = NL + "\t\t{\"HBase\",\"Ganglia\",\"Hadoop\",\"Hive\",\"Hue\",\"ZooKeeper-Sandbox\"}" + NL + "\t\t";
  protected final String TEXT_141 = NL + "\t;" + NL + "\t" + NL + "\t";
  protected final String TEXT_142 = NL + "\tif(true) {" + NL + "\t\tthrow new java.lang.RuntimeException(\"\\\"All Applications\\\" option is not supported by EMR 4.6.0\");" + NL + "\t}" + NL + "\t";
  protected final String TEXT_143 = NL + "\t\t" + NL + "    java.util.List<com.amazonaws.services.elasticmapreduce.model.Application> apps_";
  protected final String TEXT_144 = " = new java.util.ArrayList<com.amazonaws.services.elasticmapreduce.model.Application>();" + NL + "\tfor(String application_";
  protected final String TEXT_145 = " : applications_";
  protected final String TEXT_146 = ") {" + NL + "    \tcom.amazonaws.services.elasticmapreduce.model.Application app_";
  protected final String TEXT_147 = " = new com.amazonaws.services.elasticmapreduce.model.Application();" + NL + "    \tapp_";
  protected final String TEXT_148 = ".withName(application_";
  protected final String TEXT_149 = ");" + NL + "    \tapps_";
  protected final String TEXT_150 = ".add(app_";
  protected final String TEXT_151 = ");" + NL + "    }" + NL + "\t";
  protected final String TEXT_152 = NL + "\t\t\t\tjava.util.List<com.amazonaws.services.elasticmapreduce.model.Configuration> configs_";
  protected final String TEXT_153 = " = new java.util.ArrayList<com.amazonaws.services.elasticmapreduce.model.Configuration>();" + NL + "\t\t\t\tjava.util.Map<String,String> properties_";
  protected final String TEXT_154 = " = null;" + NL + "\t\t\t\tcom.amazonaws.services.elasticmapreduce.model.Configuration config_";
  protected final String TEXT_155 = " = null;" + NL + "\t\t\t";
  protected final String TEXT_156 = NL + "    \t\t\tproperties_";
  protected final String TEXT_157 = " = new java.util.HashMap<String,String>();" + NL + "    \t\t\t" + NL + "    \t\t\t";
  protected final String TEXT_158 = NL + "    \t\t\t\tproperties_";
  protected final String TEXT_159 = ".put(";
  protected final String TEXT_160 = ", ";
  protected final String TEXT_161 = ");" + NL + "    \t\t\t";
  protected final String TEXT_162 = NL + "    \t\t\t" + NL + "            \tconfig_";
  protected final String TEXT_163 = " = new com.amazonaws.services.elasticmapreduce.model.Configuration()" + NL + "                    .withClassification(";
  protected final String TEXT_164 = ")" + NL + "                    .withProperties(properties_";
  protected final String TEXT_165 = ");" + NL + "                    " + NL + "                configs_";
  protected final String TEXT_166 = ".add(config_";
  protected final String TEXT_167 = ");" + NL + "\t\t\t";
  protected final String TEXT_168 = NL + "\t" + NL + "\tcom.amazonaws.services.elasticmapreduce.model.RunJobFlowRequest request_";
  protected final String TEXT_169 = " = new com.amazonaws.services.elasticmapreduce.model.RunJobFlowRequest()" + NL + "    \t.withName(";
  protected final String TEXT_170 = ")" + NL + "    \t";
  protected final String TEXT_171 = NL + "    \t.withLogUri(";
  protected final String TEXT_172 = ")" + NL + "    \t";
  protected final String TEXT_173 = NL + "    \t" + NL + "    \t";
  protected final String TEXT_174 = NL + "    \t\t.withAmiVersion(";
  protected final String TEXT_175 = ")" + NL + "    \t";
  protected final String TEXT_176 = NL + "    \t\t.withReleaseLabel(";
  protected final String TEXT_177 = ")" + NL + "    \t";
  protected final String TEXT_178 = NL + "    \t" + NL + "    \t";
  protected final String TEXT_179 = NL + "    \t\t.withApplications(apps_";
  protected final String TEXT_180 = ")" + NL + "    \t";
  protected final String TEXT_181 = NL + "    \t" + NL + "    \t";
  protected final String TEXT_182 = NL + "    \t.withSteps(steps_";
  protected final String TEXT_183 = ")" + NL + "    \t";
  protected final String TEXT_184 = NL + "    \t" + NL + "    \t.withServiceRole(";
  protected final String TEXT_185 = ")" + NL + "    \t.withJobFlowRole(";
  protected final String TEXT_186 = ")" + NL + "    \t" + NL + "    \t";
  protected final String TEXT_187 = NL + "    \t.withVisibleToAllUsers(true)" + NL + "    \t";
  protected final String TEXT_188 = NL + "    \t" + NL + "    \t";
  protected final String TEXT_189 = NL + "    \t.withBootstrapActions(actions_";
  protected final String TEXT_190 = ")" + NL + "    \t";
  protected final String TEXT_191 = NL + "    \t" + NL + "    \t";
  protected final String TEXT_192 = NL + "    \t.withConfigurations(configs_";
  protected final String TEXT_193 = ")" + NL + "    \t";
  protected final String TEXT_194 = NL + "    \t" + NL + "    \t.withInstances(" + NL + "    \t\tnew com.amazonaws.services.elasticmapreduce.model.JobFlowInstancesConfig()" + NL + "    \t\t\t.withInstanceCount(";
  protected final String TEXT_195 = ")" + NL + "    \t\t\t";
  protected final String TEXT_196 = NL + "    \t\t\t.withEc2KeyName(";
  protected final String TEXT_197 = ")" + NL + "    \t\t\t";
  protected final String TEXT_198 = NL + "    \t\t\t.withMasterInstanceType(";
  protected final String TEXT_199 = ")" + NL + "    \t\t\t.withSlaveInstanceType(";
  protected final String TEXT_200 = ")" + NL + "    \t\t\t" + NL + "    \t\t\t";
  protected final String TEXT_201 = NL + "    \t\t\t.withEc2SubnetId(";
  protected final String TEXT_202 = ")" + NL + "    \t\t\t";
  protected final String TEXT_203 = NL + "    \t\t\t" + NL + "    \t\t\t";
  protected final String TEXT_204 = NL + "    \t\t\t.withPlacement(new com.amazonaws.services.elasticmapreduce.model.PlacementType().withAvailabilityZone(";
  protected final String TEXT_205 = "))" + NL + "    \t\t\t";
  protected final String TEXT_206 = NL + "    \t\t\t" + NL + "    \t\t\t";
  protected final String TEXT_207 = NL + "    \t\t\t.withEmrManagedMasterSecurityGroup(";
  protected final String TEXT_208 = ")" + NL + "    \t\t\t";
  protected final String TEXT_209 = NL + "    \t\t\t" + NL + "    \t\t\t";
  protected final String TEXT_210 = NL + "    \t\t\t.withAdditionalMasterSecurityGroups(";
  protected final String TEXT_211 = ".split(\",\"))" + NL + "    \t\t\t";
  protected final String TEXT_212 = NL + "    \t\t\t" + NL + "    \t\t\t";
  protected final String TEXT_213 = NL + "    \t\t\t.withEmrManagedSlaveSecurityGroup(";
  protected final String TEXT_214 = ")" + NL + "    \t\t\t";
  protected final String TEXT_215 = NL + "    \t\t\t" + NL + "    \t\t\t";
  protected final String TEXT_216 = NL + "    \t\t\t.withAdditionalSlaveSecurityGroups(";
  protected final String TEXT_217 = ".split(\",\"))" + NL + "    \t\t\t";
  protected final String TEXT_218 = NL + "    \t\t\t" + NL + "    \t\t\t";
  protected final String TEXT_219 = NL + "    \t\t\t.withTerminationProtected(true)" + NL + "    \t\t\t";
  protected final String TEXT_220 = NL + "    \t\t\t" + NL + "    \t\t\t.withKeepJobFlowAliveWhenNoSteps(";
  protected final String TEXT_221 = ")" + NL + "    \t);" + NL + "" + NL + "\tcom.amazonaws.services.elasticmapreduce.model.RunJobFlowResult result_";
  protected final String TEXT_222 = " = emr_";
  protected final String TEXT_223 = ".runJobFlow(request_";
  protected final String TEXT_224 = ");" + NL + "\t" + NL + "\t";
  protected final String TEXT_225 = NL + "\tlog.info(\"";
  protected final String TEXT_226 = " - cluster status : \" + result_";
  protected final String TEXT_227 = ");" + NL + "\t";
  protected final String TEXT_228 = NL + "\t" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_229 = "_CLUSTER_FINAL_ID\", result_";
  protected final String TEXT_230 = ".getJobFlowId());" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_231 = "_CLUSTER_FINAL_NAME\", ";
  protected final String TEXT_232 = ");" + NL + "\t" + NL + "\t";
  protected final String TEXT_233 = NL + "\t\tboolean clusterIsAlive_";
  protected final String TEXT_234 = " = false;" + NL + "        System.out.println(\"Wating for cluster to become available.\");" + NL + "        while (true) {" + NL + "            com.amazonaws.services.elasticmapreduce.model.DescribeClusterResult result2_";
  protected final String TEXT_235 = " = emr_";
  protected final String TEXT_236 = ".describeCluster(" + NL + "            \tnew com.amazonaws.services.elasticmapreduce.model.DescribeClusterRequest()" + NL + "               \t\t.withClusterId(result_";
  protected final String TEXT_237 = ".getJobFlowId())" + NL + "            );" + NL + "            String status_";
  protected final String TEXT_238 = " = result2_";
  protected final String TEXT_239 = ".getCluster().getStatus().getState();" + NL + "            if (\"WAITING\".equalsIgnoreCase(status_";
  protected final String TEXT_240 = ") || \"RUNNING\".equalsIgnoreCase(status_";
  protected final String TEXT_241 = ")) {" + NL + "            \tclusterIsAlive_";
  protected final String TEXT_242 = " = true;" + NL + "                break;" + NL + "            } else if(\"TERMINATED\".equalsIgnoreCase(status_";
  protected final String TEXT_243 = ")) {" + NL + "                break;" + NL + "            } else if(\"TERMINATED_WITH_ERRORS\".equalsIgnoreCase(status_";
  protected final String TEXT_244 = ")) {" + NL + "            \tSystem.err.println(\"Fail to start the cluster.\");" + NL + "            \tbreak;" + NL + "            } else {" + NL + "                System.out.print(\".\");" + NL + "                Thread.sleep(2000);" + NL + "            }" + NL + "        }" + NL + "\t";
  protected final String TEXT_245 = NL + NL + "\t";
  protected final String TEXT_246 = NL + "\t\tboolean waitForStep_";
  protected final String TEXT_247 = " = clusterIsAlive_";
  protected final String TEXT_248 = " && (steps_";
  protected final String TEXT_249 = ".size() > 1);" + NL + "\t\t" + NL + "\t\tif(waitForStep_";
  protected final String TEXT_250 = ") {" + NL + "        \tSystem.out.println(\"Wating for steps to complete.\");" + NL + "        }" + NL + "        " + NL + "        while (waitForStep_";
  protected final String TEXT_251 = ") {" + NL + "            com.amazonaws.services.elasticmapreduce.model.DescribeClusterResult result2_";
  protected final String TEXT_252 = " = emr_";
  protected final String TEXT_253 = ".describeCluster(" + NL + "            \tnew com.amazonaws.services.elasticmapreduce.model.DescribeClusterRequest()" + NL + "               \t\t.withClusterId(result_";
  protected final String TEXT_254 = ".getJobFlowId())" + NL + "            );" + NL + "            String status_";
  protected final String TEXT_255 = " = result2_";
  protected final String TEXT_256 = ".getCluster().getStatus().getState();" + NL + "            if (\"WAITING\".equalsIgnoreCase(status_";
  protected final String TEXT_257 = ") || \"TERMINATED\".equalsIgnoreCase(status_";
  protected final String TEXT_258 = ") || \"TERMINATING\".equalsIgnoreCase(status_";
  protected final String TEXT_259 = ")) {" + NL + "            \tbreak;" + NL + "            } else if(\"TERMINATED_WITH_ERRORS\".equalsIgnoreCase(status_";
  protected final String TEXT_260 = ")) {" + NL + "            \tSystem.err.println(\"Fail to complete steps.\");" + NL + "            \tbreak;" + NL + "            } else {" + NL + "                System.out.print(\".\");" + NL + "                Thread.sleep(2000);" + NL + "            }" + NL + "        }" + NL + "\t";
