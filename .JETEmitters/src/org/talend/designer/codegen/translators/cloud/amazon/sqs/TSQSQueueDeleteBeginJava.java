...
public class TSQSQueueDeleteBeginJava
{
  ...
  protected final String TEXT_65 = " - Deleting a queue with name:\" + ";
  protected final String TEXT_66 = ");" + NL + "\t\t";
  protected final String TEXT_67 = NL + "        conn_";
  protected final String TEXT_68 = ".deleteQueue(new com.amazonaws.services.sqs.model.DeleteQueueRequest(";
  protected final String TEXT_69 = "));" + NL + "        " + NL + "\t\t";
  protected final String TEXT_70 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_71 = " - Delete the queue successfully.\");" + NL + "\t\t";
