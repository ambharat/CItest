...
public class TSQSQueueListBeginJava
{
  ...
  protected final String TEXT_63 = NL + "\tint nb_queue_";
  protected final String TEXT_64 = " = 0;" + NL + "\t";
  protected final String TEXT_65 = NL + "\t\tlog.info(\"";
  protected final String TEXT_66 = " - Retrieving queues from the server.\");" + NL + "\t";
  protected final String TEXT_67 = NL + "\t";
  protected final String TEXT_68 = NL + "\t\ttry{" + NL + "\t";
  protected final String TEXT_69 = NL + "\t" + NL + "\tfor (String queueUrl_";
  protected final String TEXT_70 = " : conn_";
  protected final String TEXT_71 = ".listQueues().getQueueUrls()) {" + NL + "\t\tnb_queue_";
  protected final String TEXT_72 = "++;" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_73 = "_CURRENT_QUEUE_NAME\", queueUrl_";
  protected final String TEXT_74 = ");" + NL + "\t\t";
  protected final String TEXT_75 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_76 = " - Retrieving the queue \" + nb_queue_";
  protected final String TEXT_77 = " + \".\");" + NL + "\t\t\tlog.trace(\"";
  protected final String TEXT_78 = " - Name of current queue : \" + queueUrl_";
