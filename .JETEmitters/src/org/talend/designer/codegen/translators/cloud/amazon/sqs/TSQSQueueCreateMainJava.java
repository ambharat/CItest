...
public class TSQSQueueCreateMainJava
{
  ...
  protected final String TEXT_64 = NL + "\t\t\tjava.util.Map<String,String> attributes_";
  protected final String TEXT_65 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_66 = NL + "\t\t\t\t\tattributes_";
  ...
  protected final String TEXT_71 = " - Creating a queue with name:\" + ";
  protected final String TEXT_72 = ");" + NL + "\t\t";
  protected final String TEXT_73 = NL + "\t\tcom.amazonaws.services.sqs.model.CreateQueueRequest createQueueRequest_";
  protected final String TEXT_74 = " = new com.amazonaws.services.sqs.model.CreateQueueRequest(";
  protected final String TEXT_75 = ")";
  protected final String TEXT_76 = ".withAttributes(attributes_";
  protected final String TEXT_77 = ")";
  protected final String TEXT_78 = ";" + NL + "        String queueUrl_";
  protected final String TEXT_79 = " = conn_";
  protected final String TEXT_80 = ".createQueue(createQueueRequest_";
  protected final String TEXT_81 = ").getQueueUrl();" + NL + "\t\t";
  protected final String TEXT_82 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_83 = " - Create the queue successfully [\" + queueUrl_";
